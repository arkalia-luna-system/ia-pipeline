...
alias ath-optimize='python $(git rev-parse --show-toplevel)/tools/maintenance/phase3_optimization.py'
alias ath-optimize-execute='python $(git rev-parse --show-toplevel)/tools/maintenance/phase3_optimization.py --execute'
