...
- **`INDEX.md`** - Index de l'architecture
...
- **`core_modules.md`** - Modules du core
- **`ERROR_HANDLING.md`** - Gestion des erreurs
- **`orchestrator.md`** - Documentation de l'orchestrateur
- **`plugins.md`** - Système de plugins
- **`REFERENCE.md`** - Référence complète de l'API
- **`robotics.md`** - API robotique

### **👨‍💻 DÉVELOPPEUR (`docs/DEVELOPER/`)**
- **`INDEX.md`** - Index développeur
...
- **`CI_CD_PRO_PRE_COMMIT_GUIDE.md`** - Guide CI/CD avec pre-commit
- **`CI_CD_PROFESSIONAL_GUIDE.md`** - Guide CI/CD professionnel
- **`CLEAN_SHUTDOWN_GUIDE.md`** - Guide d'arrêt propre
- **`CLEANUP_GUIDE.md`** - Guide de nettoyage
- **`DEVELOPER_GUIDE.md`** - Guide développeur principal
- **`LINTING_GUIDE.md`** - Guide de linting
- **`PLUGINS_GUIDE.md`** - Guide des plugins
- **`SECURITY_LINTING_GUIDE.md`** - Guide de linting sécurité
- **`TEST_CLEANUP_GUIDE.md`** - Guide de nettoyage des tests
- **`TESTING.md`** - Guide des tests
- **`TESTS_GUIDE.md`** - Guide des tests avancé
- **`WORKFLOW_COMPLETE_GUIDE.md`** - Guide workflow complet

#### **🔧 MAINTENANCE (`docs/DEVELOPER/MAINTENANCE/`)**
- **`APPLE_DOUBLE_MANAGEMENT.md`** - Gestion des fichiers Apple Double
- **`BIN_CLEANUP_REPORT.md`** - Rapport de nettoyage bin/
- **`MACOS_TEMP_CLEANUP.md`** - Nettoyage temporaires macOS

#### **📋 PLANS (`docs/DEVELOPER/PLANS/`)**
- **`INDEX.md`** - Index des plans
- **`NETTOYAGE_REPOSITORY_PLAN.md`** - Plan de nettoyage repository
- **`OPTIMISATION_TESTS_RAM_2025.md`** - Optimisation tests RAM 2025
- **`PLAN_ACTION_COUVERTURE_2025.md`** - Plan d'action couverture 2025
- **`PLAN_ACTION_MODULARISATION_ATHALIA.md`** - Plan modularisation Athalia
- **`PLAN_CORRECTION_TESTS_2025.md`** - Plan correction tests 2025
- **`REORGANISATION_TESTS_PLAN.md`** - Plan réorganisation tests
- **`REORGANISATION_TESTS_STRUCTURE.md`** - Structure réorganisation tests

#### **📊 RAPPORTS (`docs/DEVELOPER/REPORTS/`)**
- **`AMELIORATION_DOCUMENTATION_GETTING_STARTED_DEVELOPER_20250802.md`** - Amélioration documentation getting started
- **`ANALYSE_COMPLETE_MODULES_ATHALIA.md`** - Analyse complète des modules
- **`CORRECTION_PYTEST_COVERAGE_2025.md`** - Correction pytest coverage 2025
- **`CORRECTIONS_PROGRESS.md`** - Progrès des corrections
- **`OPTIMISATION_TESTS_RAM_FINALE_2025.md`** - Optimisation tests RAM finale 2025
- **`PHASE_4_MODULES_AVANCES_PLAN.md`** - Phase 4 modules avancés
- **`RAPPORT_COMPLET_AMELIORATIONS_2025.md`** - Rapport complet améliorations 2025
- **`RAPPORT_PROGRES_2025.md`** - Rapport de progrès 2025
- **`RAPPORT_PROGRES_FINAL_2025.md`** - Rapport de progrès final 2025
- **`RESUME_ANALYSE_TESTS_2025.md`** - Résumé analyse tests 2025
