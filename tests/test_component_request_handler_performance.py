"""
Tests de performance générés automatiquement pour component_request_handler
"""
...
try:
    ...
    def test_component_request_handler_performance():
        """Test de performance pour component_request_handler"""
