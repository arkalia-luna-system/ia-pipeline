"""
Tests de performance générés automatiquement pour .__threading
"""
...
try:
    ...
    pytest.skip(f"Module .__threading non importable")

    def test_.__threading_performance():
        """Test de performance pour .__threading"""
