"""
Tests de performance générés automatiquement pour ._blank
"""
...
try:
    ...
    pytest.skip(f"Module ._blank non importable")

    def test_._blank_performance():
        """Test de performance pour ._blank"""
