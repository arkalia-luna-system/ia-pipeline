"""
Tests de performance générés automatiquement pour IFrame_pb2
"""
...
try:
    ...
    pytest.skip(f"Module IFrame_pb2 non importable")

    def test_IFrame_pb2_performance():
        """Test de performance pour IFrame_pb2"""
