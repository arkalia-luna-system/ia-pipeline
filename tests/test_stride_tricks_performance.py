"""
Tests de performance générés automatiquement pour stride_tricks
"""
...
try:
    ...
    pytest.skip(f"Module stride_tricks non importable")

    def test_stride_tricks_performance():
        """Test de performance pour stride_tricks"""
