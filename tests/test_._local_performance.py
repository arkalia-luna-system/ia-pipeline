"""
Tests de performance générés automatiquement pour ._local
"""
...
try:
    ...
    pytest.skip(f"Module ._local non importable")

    def test_._local_performance():
        """Test de performance pour ._local"""
