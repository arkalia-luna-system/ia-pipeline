"""
Tests de performance générés automatiquement pour inject_meta_charset
"""
...
try:
    ...
    def test_inject_meta_charset_performance():
        """Test de performance pour inject_meta_charset"""
