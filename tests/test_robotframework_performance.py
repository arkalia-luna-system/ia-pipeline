"""
Tests de performance générés automatiquement pour robotframework
"""
...
try:
    ...
    pytest.skip(f"Module robotframework non importable")

    def test_robotframework_performance():
        """Test de performance pour robotframework"""
