"""
Tests de performance générés automatiquement pour Radio_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Radio_pb2 non importable")

    def test_Radio_pb2_performance():
        """Test de performance pour Radio_pb2"""
