"""
Tests de performance générés automatiquement pour .__abstract_linkable
"""
...
try:
    ...
    def test_.__abstract_linkable_performance():
        """Test de performance pour .__abstract_linkable"""
