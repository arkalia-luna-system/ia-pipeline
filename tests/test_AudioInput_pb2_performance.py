"""
Tests de performance générés automatiquement pour AudioInput_pb2
"""
...
try:
    import AudioInput_pb2
except ImportError:
    pytest.skip(f"Module AudioInput_pb2 non importable")

    def test_AudioInput_pb2_performance():
        """Test de performance pour AudioInput_pb2"""
