"""
Tests de performance générés automatiquement pour PageNotFound_pb2
"""
...
try:
    import PageNotFound_pb2
except ImportError:
    pytest.skip(f"Module PageNotFound_pb2 non importable")

    def test_PageNotFound_pb2_performance():
        """Test de performance pour PageNotFound_pb2"""
