"""
Tests de performance générés automatiquement pour query_params_proxy
"""
...
try:
    ...
    def test_query_params_proxy_performance():
        """Test de performance pour query_params_proxy"""
