"""
Tests de performance générés automatiquement pour local_disk_cache_storage
"""
...
try:
    ...
    def test_local_disk_cache_storage_performance():
        """Test de performance pour local_disk_cache_storage"""
