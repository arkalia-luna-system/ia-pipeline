"""
Tests de performance générés automatiquement pour Components_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Components_pb2 non importable")

    def test_Components_pb2_performance():
        """Test de performance pour Components_pb2"""
