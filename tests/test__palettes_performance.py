"""
Tests de performance générés automatiquement pour _palettes
"""
...
try:
    ...
    pytest.skip(f"Module _palettes non importable")

    def test__palettes_performance():
        """Test de performance pour _palettes"""
