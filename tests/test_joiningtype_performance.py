"""
Tests de performance générés automatiquement pour joiningtype
"""
...
try:
    ...
    pytest.skip(f"Module joiningtype non importable")

    def test_joiningtype_performance():
        """Test de performance pour joiningtype"""
