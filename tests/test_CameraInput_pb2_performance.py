"""
Tests de performance générés automatiquement pour CameraInput_pb2
"""
...
try:
    import CameraInput_pb2
except ImportError:
    pytest.skip(f"Module CameraInput_pb2 non importable")

    def test_CameraInput_pb2_performance():
        """Test de performance pour CameraInput_pb2"""
