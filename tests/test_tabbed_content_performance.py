"""
Tests de performance générés automatiquement pour tabbed_content
"""
...
try:
    import tabbed_content
except ImportError:
    pytest.skip(f"Module tabbed_content non importable")

    def test_tabbed_content_performance():
        """Test de performance pour tabbed_content"""
