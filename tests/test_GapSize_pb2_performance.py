"""
Tests de performance générés automatiquement pour GapSize_pb2
"""
...
try:
    ...
    pytest.skip(f"Module GapSize_pb2 non importable")

    def test_GapSize_pb2_performance():
        """Test de performance pour GapSize_pb2"""
