"""
Tests de performance générés automatiquement pour _metadata_dependent
"""
...
try:
    ...
    def test__metadata_dependent_performance():
        """Test de performance pour _metadata_dependent"""
