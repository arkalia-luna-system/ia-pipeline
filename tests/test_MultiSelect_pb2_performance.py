"""
Tests de performance générés automatiquement pour MultiSelect_pb2
"""
...
try:
    import MultiSelect_pb2
except ImportError:
    pytest.skip(f"Module MultiSelect_pb2 non importable")

    def test_MultiSelect_pb2_performance():
        """Test de performance pour MultiSelect_pb2"""
