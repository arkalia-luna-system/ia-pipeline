"""
Tests de performance générés automatiquement pour .__text_area
"""
...
try:
    ...
    pytest.skip(f"Module .__text_area non importable")

    def test_.__text_area_performance():
        """Test de performance pour .__text_area"""
