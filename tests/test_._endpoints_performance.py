"""
Tests de performance générés automatiquement pour ._endpoints
"""
...
try:
    ...
    pytest.skip(f"Module ._endpoints non importable")

    def test_._endpoints_performance():
        """Test de performance pour ._endpoints"""
