"""
Tests de performance générés automatiquement pour ._simple_client
"""
...
try:
    import ._simple_client
except ImportError:
    pytest.skip(f"Module ._simple_client non importable")

    def test_._simple_client_performance():
        """Test de performance pour ._simple_client"""
