"""
Tests de performance générés automatiquement pour ._filter
"""
...
try:
    ...
    pytest.skip(f"Module ._filter non importable")

    def test_._filter_performance():
        """Test de performance pour ._filter"""
