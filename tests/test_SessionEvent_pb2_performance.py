"""
Tests de performance générés automatiquement pour SessionEvent_pb2
"""
...
try:
    import SessionEvent_pb2
except ImportError:
    pytest.skip(f"Module SessionEvent_pb2 non importable")

    def test_SessionEvent_pb2_performance():
        """Test de performance pour SessionEvent_pb2"""
