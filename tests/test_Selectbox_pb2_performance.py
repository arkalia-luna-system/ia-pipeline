"""
Tests de performance générés automatiquement pour Selectbox_pb2
"""
...
try:
    import Selectbox_pb2
except ImportError:
    pytest.skip(f"Module Selectbox_pb2 non importable")

    def test_Selectbox_pb2_performance():
        """Test de performance pour Selectbox_pb2"""
