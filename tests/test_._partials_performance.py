"""
Tests de performance générés automatiquement pour ._partials
"""
...
try:
    ...
    pytest.skip(f"Module ._partials non importable")

    def test_._partials_performance():
        """Test de performance pour ._partials"""
