"""
Tests de performance générés automatiquement pour NewSession_pb2
"""
...
try:
    import NewSession_pb2
except ImportError:
    pytest.skip(f"Module NewSession_pb2 non importable")

    def test_NewSession_pb2_performance():
        """Test de performance pour NewSession_pb2"""
