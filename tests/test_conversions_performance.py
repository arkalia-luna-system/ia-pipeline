"""
Tests de performance générés automatiquement pour conversions
"""
...
try:
    ...
    pytest.skip(f"Module conversions non importable")

    def test_conversions_performance():
        """Test de performance pour conversions"""
