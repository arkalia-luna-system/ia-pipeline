"""
Tests de performance générés automatiquement pour Spinner_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Spinner_pb2 non importable")

    def test_Spinner_pb2_performance():
        """Test de performance pour Spinner_pb2"""
