"""
Tests de performance générés automatiquement pour _magentic_one_group_chat
"""
...
try:
    ...
    def test__magentic_one_group_chat_performance():
        """Test de performance pour _magentic_one_group_chat"""
