"""
Tests de performance générés automatiquement pour ._selection
"""
...
try:
    ...
    pytest.skip(f"Module ._selection non importable")

    def test_._selection_performance():
        """Test de performance pour ._selection"""
