"""
Tests de performance générés automatiquement pour .__input_reader_linux
"""
...
try:
    ...
    def test_.__input_reader_linux_performance():
        """Test de performance pour .__input_reader_linux"""
