"""
Tests de performance générés automatiquement pour stats_request_handler
"""
...
try:
    ...
    def test_stats_request_handler_performance():
        """Test de performance pour stats_request_handler"""
