"""
Tests de performance générés automatiquement pour ._tbtools
"""
...
try:
    ...
    pytest.skip(f"Module ._tbtools non importable")

    def test_._tbtools_performance():
        """Test de performance pour ._tbtools"""
