"""
Tests de performance générés automatiquement pour _subscription_context
"""
...
try:
    ...
    def test__subscription_context_performance():
        """Test de performance pour _subscription_context"""
