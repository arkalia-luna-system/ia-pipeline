"""
Tests de performance générés automatiquement pour ._expand_tabs
"""
...
try:
    ...
    pytest.skip(f"Module ._expand_tabs non importable")

    def test_._expand_tabs_performance():
        """Test de performance pour ._expand_tabs"""
