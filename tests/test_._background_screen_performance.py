"""
Tests de performance générés automatiquement pour ._background_screen
"""
...
try:
    ...
    def test_._background_screen_performance():
        """Test de performance pour ._background_screen"""
