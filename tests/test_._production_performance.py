"""
Tests de performance générés automatiquement pour ._production
"""
...
try:
    ...
    pytest.skip(f"Module ._production non importable")

    def test_._production_performance():
        """Test de performance pour ._production"""
