"""
Tests de performance générés automatiquement pour Common_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Common_pb2 non importable")

    def test_Common_pb2_performance():
        """Test de performance pour Common_pb2"""
