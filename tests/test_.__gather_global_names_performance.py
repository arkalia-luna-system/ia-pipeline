"""
Tests de performance générés automatiquement pour .__gather_global_names
"""
...
try:
    ...
    def test_.__gather_global_names_performance():
        """Test de performance pour .__gather_global_names"""
