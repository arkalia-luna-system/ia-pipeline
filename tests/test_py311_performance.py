"""
Tests de performance générés automatiquement pour py311
"""
...
try:
    ...
    pytest.skip(f"Module py311 non importable")

    def test_py311_performance():
        """Test de performance pour py311"""
