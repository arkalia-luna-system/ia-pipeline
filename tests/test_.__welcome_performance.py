"""
Tests de performance générés automatiquement pour .__welcome
"""
...
try:
    ...
    pytest.skip(f"Module .__welcome non importable")

    def test_.__welcome_performance():
        """Test de performance pour .__welcome"""
