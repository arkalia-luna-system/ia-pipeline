"""
Tests de performance générés automatiquement pour ._features
"""
...
try:
    ...
    pytest.skip(f"Module ._features non importable")

    def test_._features_performance():
        """Test de performance pour ._features"""
