"""
Tests de performance générés automatiquement pour ._strip
"""
...
try:
    ...
    pytest.skip(f"Module ._strip non importable")

    def test_._strip_performance():
        """Test de performance pour ._strip"""
