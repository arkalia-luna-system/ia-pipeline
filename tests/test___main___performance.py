"""
Tests de performance générés automatiquement pour __main__
"""
...
try:
    ...
    pytest.skip(f"Module __main__ non importable")

    def test___main___performance():
        """Test de performance pour __main__"""
