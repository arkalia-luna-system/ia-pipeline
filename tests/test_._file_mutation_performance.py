"""
Tests de performance générés automatiquement pour ._file_mutation
"""
...
try:
    import ._file_mutation
except ImportError:
    pytest.skip(f"Module ._file_mutation non importable")

    def test_._file_mutation_performance():
        """Test de performance pour ._file_mutation"""
