"""
Tests de performance générés automatiquement pour _input_reader_linux
"""
...
try:
    ...
    def test__input_reader_linux_performance():
        """Test de performance pour _input_reader_linux"""
