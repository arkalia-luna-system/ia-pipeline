"""
Tests de performance générés automatiquement pour functional_serializers
"""
...
try:
    ...
    def test_functional_serializers_performance():
        """Test de performance pour functional_serializers"""
