"""
Tests de performance générés automatiquement pour _stan_builtins
"""
...
try:
    ...
    pytest.skip(f"Module _stan_builtins non importable")

    def test__stan_builtins_performance():
        """Test de performance pour _stan_builtins"""
