"""
Tests de performance générés automatiquement pour .__binary_encode
"""
...
try:
    import .__binary_encode
except ImportError:
    pytest.skip(f"Module .__binary_encode non importable")

    def test_.__binary_encode_performance():
        """Test de performance pour .__binary_encode"""
