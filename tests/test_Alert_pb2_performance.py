"""
Tests de performance générés automatiquement pour Alert_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Alert_pb2 non importable")

    def test_Alert_pb2_performance():
        """Test de performance pour Alert_pb2"""
