"""
Tests de performance générés automatiquement pour ._base_key
"""
...
try:
    ...
    pytest.skip(f"Module ._base_key non importable")

    def test_._base_key_performance():
        """Test de performance pour ._base_key"""
