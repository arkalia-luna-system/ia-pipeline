"""
Tests de performance générés automatiquement pour operators
"""
...
try:
    ...
    pytest.skip(f"Module operators non importable")

    def test_operators_performance():
        """Test de performance pour operators"""
