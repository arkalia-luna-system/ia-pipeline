# Template de test pour athalia_core/analysis/ast_analyzer.py
# Fichier: tests/test_ast_analyzer.py

import athalia_core.analysis.ast_analyzer as module


class TestAst_Analyzer:
    """Tests pour le module ast_analyzer"""
