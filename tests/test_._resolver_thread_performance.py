"""
Tests de performance générés automatiquement pour ._resolver_thread
"""
...
try:
    import ._resolver_thread
except ImportError:
    pytest.skip(f"Module ._resolver_thread non importable")

    def test_._resolver_thread_performance():
        """Test de performance pour ._resolver_thread"""
