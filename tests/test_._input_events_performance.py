"""
Tests de performance générés automatiquement pour ._input_events
"""
...
try:
    import ._input_events
except ImportError:
    pytest.skip(f"Module ._input_events non importable")

    def test_._input_events_performance():
        """Test de performance pour ._input_events"""
