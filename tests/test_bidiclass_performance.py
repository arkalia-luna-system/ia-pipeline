"""
Tests de performance générés automatiquement pour bidiclass
"""
...
try:
    ...
    pytest.skip(f"Module bidiclass non importable")

    def test_bidiclass_performance():
        """Test de performance pour bidiclass"""
