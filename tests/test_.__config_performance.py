"""
Tests de performance générés automatiquement pour .__config
"""
...
try:
    ...
    pytest.skip(f"Module .__config non importable")

    def test_.__config_performance():
        """Test de performance pour .__config"""
