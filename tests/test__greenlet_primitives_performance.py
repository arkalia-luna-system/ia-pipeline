"""
Tests de performance générés automatiquement pour _greenlet_primitives
"""
...
try:
    ...
    def test__greenlet_primitives_performance():
        """Test de performance pour _greenlet_primitives"""
