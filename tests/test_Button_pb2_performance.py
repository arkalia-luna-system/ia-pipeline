"""
Tests de performance générés automatiquement pour Button_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Button_pb2 non importable")

    def test_Button_pb2_performance():
        """Test de performance pour Button_pb2"""
