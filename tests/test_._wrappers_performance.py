"""
Tests de performance générés automatiquement pour ._wrappers
"""
...
try:
    ...
    pytest.skip(f"Module ._wrappers non importable")

    def test_._wrappers_performance():
        """Test de performance pour ._wrappers"""
