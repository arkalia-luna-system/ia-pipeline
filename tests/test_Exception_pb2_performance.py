"""
Tests de performance générés automatiquement pour Exception_pb2
"""
...
try:
    import Exception_pb2
except ImportError:
    pytest.skip(f"Module Exception_pb2 non importable")

    def test_Exception_pb2_performance():
        """Test de performance pour Exception_pb2"""
