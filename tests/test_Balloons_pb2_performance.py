"""
Tests de performance générés automatiquement pour Balloons_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Balloons_pb2 non importable")

    def test_Balloons_pb2_performance():
        """Test de performance pour Balloons_pb2"""
