"""
Tests de performance générés automatiquement pour ._headless_driver
"""
...
try:
    import ._headless_driver
except ImportError:
    pytest.skip(f"Module ._headless_driver non importable")

    def test_._headless_driver_performance():
        """Test de performance pour ._headless_driver"""
