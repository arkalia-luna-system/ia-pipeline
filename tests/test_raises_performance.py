"""
Tests de performance générés automatiquement pour raises
"""
...
try:
    ...
    pytest.skip(f"Module raises non importable")

    def test_raises_performance():
        """Test de performance pour raises"""
