"""
Tests de performance générés automatiquement pour _gather_string_annotation_names
"""
...
try:
    ...
    def test__gather_string_annotation_names_performance():
        """Test de performance pour _gather_string_annotation_names"""
