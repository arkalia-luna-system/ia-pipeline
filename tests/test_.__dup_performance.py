"""
Tests de performance générés automatiquement pour .__dup
"""
...
try:
    ...
    pytest.skip(f"Module .__dup non importable")

    def test_.__dup_performance():
        """Test de performance pour .__dup"""
