"""
Tests de performance générés automatiquement pour __about__
"""
...
try:
    ...
    pytest.skip(f"Module __about__ non importable")

    def test___about___performance():
        """Test de performance pour __about__"""
