"""
Tests de performance générés automatiquement pour Image_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Image_pb2 non importable")

    def test_Image_pb2_performance():
        """Test de performance pour Image_pb2"""
