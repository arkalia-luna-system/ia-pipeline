"""
Tests de performance générés automatiquement pour _build_tables
"""
...
try:
    import _build_tables
except ImportError:
    pytest.skip(f"Module _build_tables non importable")

    def test__build_tables_performance():
        """Test de performance pour _build_tables"""
