"""
Tests de performance générés automatiquement pour .__hostsfile
"""
...
try:
    ...
    pytest.skip(f"Module .__hostsfile non importable")

    def test_.__hostsfile_performance():
        """Test de performance pour .__hostsfile"""
