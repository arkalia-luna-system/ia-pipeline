"""
Tests de performance générés automatiquement pour messages
"""
...
try:
    ...
    pytest.skip(f"Module messages non importable")

    def test_messages_performance():
        """Test de performance pour messages"""
