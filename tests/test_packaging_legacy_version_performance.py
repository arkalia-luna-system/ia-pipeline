"""
Tests de performance générés automatiquement pour packaging_legacy_version
"""
...
try:
    ...
    def test_packaging_legacy_version_performance():
        """Test de performance pour packaging_legacy_version"""
