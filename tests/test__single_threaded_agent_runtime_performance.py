"""
Tests de performance générés automatiquement pour _single_threaded_agent_runtime
"""
...
try:
    ...
    def test__single_threaded_agent_runtime_performance():
        """Test de performance pour _single_threaded_agent_runtime"""
