"""
Tests de performance générés automatiquement pour ._fix_variadic_callable
"""
...
try:
    ...
    def test_._fix_variadic_callable_performance():
        """Test de performance pour ._fix_variadic_callable"""
