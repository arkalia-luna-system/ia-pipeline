"""
Tests de performance générés automatiquement pour ._case
"""
...
try:
    ...
    pytest.skip(f"Module ._case non importable")

    def test_._case_performance():
        """Test de performance pour ._case"""
