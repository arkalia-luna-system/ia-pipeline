...
class TestCIFinal:
    ...
    def test_test_discovery(self):
        ...
        ci_tests = ["test_ci_ultra_fast.py", "test_ci_robust.py",
                   "test_ci_final.py"]
        for test in ci_tests:
            assert Path(f"tests/{test}").exists(), (
                f"Test CI manquant: {test}")
    ...
    def test_performance_ci(self):
        ...
        assert end_time - start_time < 5.0, (
            f"Import trop lent: {end_time - start_time:.2f}s")
