"""
Tests de performance générés automatiquement pour _union_transformer
"""
...
try:
    ...
    def test__union_transformer_performance():
        """Test de performance pour _union_transformer"""
