"""
Tests de performance générés automatiquement pour ._timeout
"""
...
try:
    ...
    pytest.skip(f"Module ._timeout non importable")

    def test_._timeout_performance():
        """Test de performance pour ._timeout"""
