"""
Tests de performance générés automatiquement pour ._client_credentials
"""
...
try:
    ...
    def test_._client_credentials_performance():
        """Test de performance pour ._client_credentials"""
