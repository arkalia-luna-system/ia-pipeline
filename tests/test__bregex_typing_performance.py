"""
Tests de performance générés automatiquement pour _bregex_typing
"""
...
try:
    import _bregex_typing
except ImportError:
    pytest.skip(f"Module _bregex_typing non importable")

    def test__bregex_typing_performance():
        """Test de performance pour _bregex_typing"""
