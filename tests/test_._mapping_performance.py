"""
Tests de performance générés automatiquement pour ._mapping
"""
...
try:
    ...
    pytest.skip(f"Module ._mapping non importable")

    def test_._mapping_performance():
        """Test de performance pour ._mapping"""
