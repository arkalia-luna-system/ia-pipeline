"""
Tests de performance générés automatiquement pour ufuncs
"""
...
try:
    ...
    pytest.skip(f"Module ufuncs non importable")

    def test_ufuncs_performance():
        """Test de performance pour ufuncs"""
