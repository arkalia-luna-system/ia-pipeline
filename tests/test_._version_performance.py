"""
Tests de performance générés automatiquement pour ._version
"""
...
try:
    ...
    pytest.skip(f"Module ._version non importable")

    def test_._version_performance():
        """Test de performance pour ._version"""
