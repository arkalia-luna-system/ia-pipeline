"""
Tests de performance générés automatiquement pour app_static_file_handler
"""
...
try:
    ...
    def test_app_static_file_handler_performance():
        """Test de performance pour app_static_file_handler"""
