"""
Tests de performance générés automatiquement pour .__edit
"""
...
try:
    ...
    pytest.skip(f"Module .__edit non importable")

    def test_.__edit_performance():
        """Test de performance pour .__edit"""
