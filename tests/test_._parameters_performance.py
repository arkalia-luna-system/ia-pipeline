"""
Tests de performance générés automatiquement pour ._parameters
"""
...
try:
    ...
    pytest.skip(f"Module ._parameters non importable")

    def test_._parameters_performance():
        """Test de performance pour ._parameters"""
