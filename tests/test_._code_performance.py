"""
Tests de performance générés automatiquement pour ._code
"""
...
try:
    ...
    pytest.skip(f"Module ._code non importable")

    def test_._code_performance():
        """Test de performance pour ._code"""
