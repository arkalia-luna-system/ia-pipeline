...
class TestSecurityPatterns:
    ...
    def test_no_debug_code(self):
        ...
        if debug_code:
            pytest.fail(f"Code de debug trouvé:\n" + "\n".join(debug_code))
    ...
    def test_no_hardcoded_urls(self):
        ...
        url_patterns = [r'http://[^\s"\']+', r'https://[^\s"\']+', r'ftp://[^\s"\']+']
        ...
        if hardcoded_urls:
            pytest.fail(f"URLs hardcodées trouvées:\n" + "\n".join(hardcoded_urls))
    ...
    def test_no_weak_crypto(self):
        ...
        if weak_crypto:
            pytest.fail(f"Crypto faible trouvée:\n" + "\n".join(weak_crypto))
