"""
Tests de performance générés automatiquement pour .__utils
"""
...
try:
    ...
    pytest.skip(f"Module .__utils non importable")

    def test_.__utils_performance():
        """Test de performance pour .__utils"""
