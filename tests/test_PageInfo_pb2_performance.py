"""
Tests de performance générés automatiquement pour PageInfo_pb2
"""
...
try:
    ...
    pytest.skip(f"Module PageInfo_pb2 non importable")

    def test_PageInfo_pb2_performance():
        """Test de performance pour PageInfo_pb2"""
