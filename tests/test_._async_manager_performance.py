"""
Tests de performance générés automatiquement pour ._async_manager
"""
...
try:
    import ._async_manager
except ImportError:
    pytest.skip(f"Module ._async_manager non importable")

    def test_._async_manager_performance():
        """Test de performance pour ._async_manager"""
