"""
Tests de performance générés automatiquement pour ._pywsgi
"""
...
try:
    ...
    pytest.skip(f"Module ._pywsgi non importable")

    def test_._pywsgi_performance():
        """Test de performance pour ._pywsgi"""
