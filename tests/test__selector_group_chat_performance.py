"""
Tests de performance générés automatiquement pour _selector_group_chat
"""
...
try:
    ...
    def test__selector_group_chat_performance():
        """Test de performance pour _selector_group_chat"""
