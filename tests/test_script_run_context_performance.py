"""
Tests de performance générés automatiquement pour script_run_context
"""
...
try:
    ...
    def test_script_run_context_performance():
        """Test de performance pour script_run_context"""
