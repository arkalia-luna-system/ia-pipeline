"""
Tests de performance générés automatiquement pour PagesChanged_pb2
"""
...
try:
    import PagesChanged_pb2
except ImportError:
    pytest.skip(f"Module PagesChanged_pb2 non importable")

    def test_PagesChanged_pb2_performance():
        """Test de performance pour PagesChanged_pb2"""
