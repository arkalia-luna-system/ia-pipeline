"""
Tests de performance générés automatiquement pour consts
"""
...
try:
    ...
    pytest.skip(f"Module consts non importable")

    def test_consts_performance():
        """Test de performance pour consts"""
