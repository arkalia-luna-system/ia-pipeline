"""
Tests de performance générés automatiquement pour .__cli
"""
...
try:
    ...
    pytest.skip(f"Module .__cli non importable")

    def test_.__cli_performance():
        """Test de performance pour .__cli"""
