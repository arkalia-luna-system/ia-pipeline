"""
Tests de performance générés automatiquement pour .__segment_tools
"""
...
try:
    import .__segment_tools
except ImportError:
    pytest.skip(f"Module .__segment_tools non importable")

    def test_.__segment_tools_performance():
        """Test de performance pour .__segment_tools"""
