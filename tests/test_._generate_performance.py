"""
Tests de performance générés automatiquement pour ._generate
"""
...
try:
    ...
    pytest.skip(f"Module ._generate non importable")

    def test_._generate_performance():
        """Test de performance pour ._generate"""
