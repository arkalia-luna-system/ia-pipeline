"""
Tests de performance générés automatiquement pour monitoredqueuedevice
"""
...
try:
    ...
    def test_monitoredqueuedevice_performance():
        """Test de performance pour monitoredqueuedevice"""
