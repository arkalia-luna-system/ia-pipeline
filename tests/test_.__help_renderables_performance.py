"""
Tests de performance générés automatiquement pour .__help_renderables
"""
...
try:
    ...
    def test_.__help_renderables_performance():
        """Test de performance pour .__help_renderables"""
