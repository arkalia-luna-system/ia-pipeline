"""
Tests de performance générés automatiquement pour async_pubsub_manager
"""
...
try:
    ...
    def test_async_pubsub_manager_performance():
        """Test de performance pour async_pubsub_manager"""
