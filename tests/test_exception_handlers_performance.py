"""
Tests de performance générés automatiquement pour exception_handlers
"""
...
try:
    ...
    pytest.skip(f"Module exception_handlers non importable")

    def test_exception_handlers_performance():
        """Test de performance pour exception_handlers"""
