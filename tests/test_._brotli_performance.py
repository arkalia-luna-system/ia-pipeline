"""
Tests de performance générés automatiquement pour ._brotli
"""
...
try:
    ...
    pytest.skip(f"Module ._brotli non importable")

    def test_._brotli_performance():
        """Test de performance pour ._brotli"""
