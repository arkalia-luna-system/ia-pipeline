"""
Tests de performance générés automatiquement pour ._async_socket
"""
...
try:
    import ._async_socket
except ImportError:
    pytest.skip(f"Module ._async_socket non importable")

    def test_._async_socket_performance():
        """Test de performance pour ._async_socket"""
