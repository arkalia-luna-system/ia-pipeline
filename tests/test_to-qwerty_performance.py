"""
Tests de performance générés automatiquement pour to-qwerty
"""
...
try:
    ...
    pytest.skip(f"Module to-qwerty non importable")

    def test_to-qwerty_performance():
        """Test de performance pour to-qwerty"""
