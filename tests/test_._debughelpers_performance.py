"""
Tests de performance générés automatiquement pour ._debughelpers
"""
...
try:
    import ._debughelpers
except ImportError:
    pytest.skip(f"Module ._debughelpers non importable")

    def test_._debughelpers_performance():
        """Test de performance pour ._debughelpers"""
