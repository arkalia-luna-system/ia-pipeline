"""
Tests de performance générés automatiquement pour ._aiohttp
"""
...
try:
    ...
    pytest.skip(f"Module ._aiohttp non importable")

    def test_._aiohttp_performance():
        """Test de performance pour ._aiohttp"""
