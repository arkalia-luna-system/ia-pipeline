"""
Tests de performance générés automatiquement pour Skeleton_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Skeleton_pb2 non importable")

    def test_Skeleton_pb2_performance():
        """Test de performance pour Skeleton_pb2"""
