"""
Tests de performance générés automatiquement pour experimental_query_params
"""
...
try:
    ...
    def test_experimental_query_params_performance():
        """Test de performance pour experimental_query_params"""
