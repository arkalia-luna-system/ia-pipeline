"""
Tests de performance générés automatiquement pour ._rounding
"""
...
try:
    ...
    pytest.skip(f"Module ._rounding non importable")

    def test_._rounding_performance():
        """Test de performance pour ._rounding"""
