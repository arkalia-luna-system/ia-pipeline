"""
Tests de performance générés automatiquement pour Audio_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Audio_pb2 non importable")

    def test_Audio_pb2_performance():
        """Test de performance pour Audio_pb2"""
