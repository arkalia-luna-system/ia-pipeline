"""
Tests de performance générés automatiquement pour ._timing
"""
...
try:
    ...
    pytest.skip(f"Module ._timing non importable")

    def test_._timing_performance():
        """Test de performance pour ._timing"""
