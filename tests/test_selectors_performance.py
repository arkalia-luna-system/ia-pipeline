"""
Tests de performance générés automatiquement pour selectors
"""
...
try:
    ...
    pytest.skip(f"Module selectors non importable")

    def test_selectors_performance():
        """Test de performance pour selectors"""
