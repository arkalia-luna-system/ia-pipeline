"""
Tests de performance générés automatiquement pour _message_handler_context
"""
...
try:
    ...
    def test__message_handler_context_performance():
        """Test de performance pour _message_handler_context"""
