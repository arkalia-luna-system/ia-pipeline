"""
Tests de performance générés automatiquement pour _csound_builtins
"""
...
try:
    import _csound_builtins
except ImportError:
    pytest.skip(f"Module _csound_builtins non importable")

    def test__csound_builtins_performance():
        """Test de performance pour _csound_builtins"""
