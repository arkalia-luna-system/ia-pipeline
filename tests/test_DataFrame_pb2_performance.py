"""
Tests de performance générés automatiquement pour DataFrame_pb2
"""
...
try:
    ...
    pytest.skip(f"Module DataFrame_pb2 non importable")

    def test_DataFrame_pb2_performance():
        """Test de performance pour DataFrame_pb2"""
