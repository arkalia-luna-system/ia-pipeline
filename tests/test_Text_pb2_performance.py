"""
Tests de performance générés automatiquement pour Text_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Text_pb2 non importable")

    def test_Text_pb2_performance():
        """Test de performance pour Text_pb2"""
