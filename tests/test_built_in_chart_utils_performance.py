"""
Tests de performance générés automatiquement pour built_in_chart_utils
"""
...
try:
    ...
    def test_built_in_chart_utils_performance():
        """Test de performance pour built_in_chart_utils"""
