"""
Tests de performance générés automatiquement pour _sequential_routed_agent
"""
...
try:
    ...
    def test__sequential_routed_agent_performance():
        """Test de performance pour _sequential_routed_agent"""
