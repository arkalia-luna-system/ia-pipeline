...
class TestPerformancePhase3:
    ...
    def test_import_performance(self):
        ...
        import athalia_core.utilities.cli as ath_cli  # noqa: F401
    ...
    def test_test_execution_performance(self):
        ...
        result = subprocess.run(
            [
                ...
                "-m",
                "pytest",
                "tests/unit/general/test_ci_robust.py::TestCIRobust::test_python_environment",
                "-q",
            ],
            capture_output=True,
            text=True,
    ...
    def test_disk_space_analysis(self):
        ...
        # Vérifier que la taille est raisonnable (< 5GB pour les projets avec archives et logs volumineux)
        assert total_size_mb < 5120, (
