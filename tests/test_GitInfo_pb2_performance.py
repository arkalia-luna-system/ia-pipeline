"""
Tests de performance générés automatiquement pour GitInfo_pb2
"""
...
try:
    ...
    pytest.skip(f"Module GitInfo_pb2 non importable")

    def test_GitInfo_pb2_performance():
        """Test de performance pour GitInfo_pb2"""
