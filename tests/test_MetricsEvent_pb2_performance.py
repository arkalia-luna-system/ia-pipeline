"""
Tests de performance générés automatiquement pour MetricsEvent_pb2
"""
...
try:
    import MetricsEvent_pb2
except ImportError:
    pytest.skip(f"Module MetricsEvent_pb2 non importable")

    def test_MetricsEvent_pb2_performance():
        """Test de performance pour MetricsEvent_pb2"""
