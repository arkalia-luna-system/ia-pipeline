"""
Tests de performance générés automatiquement pour _completion_shared
"""
...
try:
    ...
    def test__completion_shared_performance():
        """Test de performance pour _completion_shared"""
