"""
Tests de performance générés automatiquement pour ._runners
"""
...
try:
    ...
    pytest.skip(f"Module ._runners non importable")

    def test_._runners_performance():
        """Test de performance pour ._runners"""
