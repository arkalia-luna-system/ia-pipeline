"""
Tests de performance générés automatiquement pour ._expression
"""
...
try:
    ...
    pytest.skip(f"Module ._expression non importable")

    def test_._expression_performance():
        """Test de performance pour ._expression"""
