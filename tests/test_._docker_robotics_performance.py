"""
Tests de performance générés automatiquement pour ._docker_robotics
"""
...
try:
    import ._docker_robotics
except ImportError:
    pytest.skip(f"Module ._docker_robotics non importable")

    def test_._docker_robotics_performance():
        """Test de performance pour ._docker_robotics"""
