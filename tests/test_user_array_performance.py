"""
Tests de performance générés automatiquement pour user_array
"""
...
try:
    ...
    pytest.skip(f"Module user_array non importable")

    def test_user_array_performance():
        """Test de performance pour user_array"""
