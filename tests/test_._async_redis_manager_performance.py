"""
Tests de performance générés automatiquement pour ._async_redis_manager
"""
...
try:
    ...
    def test_._async_redis_manager_performance():
        """Test de performance pour ._async_redis_manager"""
