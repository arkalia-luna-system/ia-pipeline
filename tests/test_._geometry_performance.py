"""
Tests de performance générés automatiquement pour ._geometry
"""
...
try:
    ...
    pytest.skip(f"Module ._geometry non importable")

    def test_._geometry_performance():
        """Test de performance pour ._geometry"""
