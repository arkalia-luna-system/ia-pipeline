"""
Tests de performance générés automatiquement pour .__gather_exports
"""
...
try:
    import .__gather_exports
except ImportError:
    pytest.skip(f"Module .__gather_exports non importable")

    def test_.__gather_exports_performance():
        """Test de performance pour .__gather_exports"""
