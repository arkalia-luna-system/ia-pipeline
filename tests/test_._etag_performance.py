"""
Tests de performance générés automatiquement pour ._etag
"""
...
try:
    ...
    pytest.skip(f"Module ._etag non importable")

    def test_._etag_performance():
        """Test de performance pour ._etag"""
