"""
Tests de performance générés automatiquement pour ButtonGroup_pb2
"""
...
try:
    import ButtonGroup_pb2
except ImportError:
    pytest.skip(f"Module ButtonGroup_pb2 non importable")

    def test_ButtonGroup_pb2_performance():
        """Test de performance pour ButtonGroup_pb2"""
