"""
Tests de performance générés automatiquement pour ._async_aiopika_manager
"""
...
try:
    ...
    def test_._async_aiopika_manager_performance():
        """Test de performance pour ._async_aiopika_manager"""
