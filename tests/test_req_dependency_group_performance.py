"""
Tests de performance générés automatiquement pour req_dependency_group
"""
...
try:
    ...
    def test_req_dependency_group_performance():
        """Test de performance pour req_dependency_group"""
