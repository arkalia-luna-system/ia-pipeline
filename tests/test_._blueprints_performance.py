"""
Tests de performance générés automatiquement pour ._blueprints
"""
...
try:
    ...
    pytest.skip(f"Module ._blueprints non importable")

    def test_._blueprints_performance():
        """Test de performance pour ._blueprints"""
