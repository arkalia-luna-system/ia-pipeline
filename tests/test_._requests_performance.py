"""
Tests de performance générés automatiquement pour ._requests
"""
...
try:
    ...
    pytest.skip(f"Module ._requests non importable")

    def test_._requests_performance():
        """Test de performance pour ._requests"""
