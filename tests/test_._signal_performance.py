"""
Tests de performance générés automatiquement pour ._signal
"""
...
try:
    ...
    pytest.skip(f"Module ._signal non importable")

    def test_._signal_performance():
        """Test de performance pour ._signal"""
