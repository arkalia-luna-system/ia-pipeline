"""
Tests de performance générés automatiquement pour html_blocks
"""
...
try:
    ...
    pytest.skip(f"Module html_blocks non importable")

    def test_html_blocks_performance():
        """Test de performance pour html_blocks"""
