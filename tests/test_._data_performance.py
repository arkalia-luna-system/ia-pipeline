"""
Tests de performance générés automatiquement pour ._data
"""
...
try:
    ...
    pytest.skip(f"Module ._data non importable")

    def test_._data_performance():
        """Test de performance pour ._data"""
