"""
Tests de performance générés automatiquement pour type_pb2
"""
...
try:
    ...
    pytest.skip(f"Module type_pb2 non importable")

    def test_type_pb2_performance():
        """Test de performance pour type_pb2"""
