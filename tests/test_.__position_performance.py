"""
Tests de performance générés automatiquement pour .__position
"""
...
try:
    ...
    pytest.skip(f"Module .__position non importable")

    def test_.__position_performance():
        """Test de performance pour .__position"""
