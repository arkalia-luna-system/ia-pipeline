"""
Tests de performance générés automatiquement pour ._jwt_bearer
"""
...
try:
    ...
    pytest.skip(f"Module ._jwt_bearer non importable")

    def test_._jwt_bearer_performance():
        """Test de performance pour ._jwt_bearer"""
