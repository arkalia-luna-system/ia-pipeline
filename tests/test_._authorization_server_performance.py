"""
Tests de performance générés automatiquement pour ._authorization_server
"""
...
try:
    ...
    def test_._authorization_server_performance():
        """Test de performance pour ._authorization_server"""
