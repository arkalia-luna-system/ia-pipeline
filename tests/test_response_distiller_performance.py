"""
Tests de performance générés automatiquement pour response_distiller
"""
...
try:
    ...
    def test_response_distiller_performance():
        """Test de performance pour response_distiller"""
