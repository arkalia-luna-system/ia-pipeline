"""
Tests de performance générés automatiquement pour .__loop
"""
...
try:
    ...
    pytest.skip(f"Module .__loop non importable")

    def test_.__loop_performance():
        """Test de performance pour .__loop"""
