"""
Tests de performance générés automatiquement pour Empty_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Empty_pb2 non importable")

    def test_Empty_pb2_performance():
        """Test de performance pour Empty_pb2"""
