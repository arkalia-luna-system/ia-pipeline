"""
Tests de performance générés automatiquement pour WidgetStates_pb2
"""
...
try:
    import WidgetStates_pb2
except ImportError:
    pytest.skip(f"Module WidgetStates_pb2 non importable")

    def test_WidgetStates_pb2_performance():
        """Test de performance pour WidgetStates_pb2"""
