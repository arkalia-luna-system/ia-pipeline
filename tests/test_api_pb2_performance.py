"""
Tests de performance générés automatiquement pour api_pb2
"""
...
try:
    ...
    pytest.skip(f"Module api_pb2 non importable")

    def test_api_pb2_performance():
        """Test de performance pour api_pb2"""
