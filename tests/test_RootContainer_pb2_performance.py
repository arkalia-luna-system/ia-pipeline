"""
Tests de performance générés automatiquement pour RootContainer_pb2
"""
...
try:
    import RootContainer_pb2
except ImportError:
    pytest.skip(f"Module RootContainer_pb2 non importable")

    def test_RootContainer_pb2_performance():
        """Test de performance pour RootContainer_pb2"""
