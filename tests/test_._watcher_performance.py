"""
Tests de performance générés automatiquement pour ._watcher
"""
...
try:
    ...
    pytest.skip(f"Module ._watcher non importable")

    def test_._watcher_performance():
        """Test de performance pour ._watcher"""
