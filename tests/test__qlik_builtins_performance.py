"""
Tests de performance générés automatiquement pour _qlik_builtins
"""
...
try:
    import _qlik_builtins
except ImportError:
    pytest.skip(f"Module _qlik_builtins non importable")

    def test__qlik_builtins_performance():
        """Test de performance pour _qlik_builtins"""
