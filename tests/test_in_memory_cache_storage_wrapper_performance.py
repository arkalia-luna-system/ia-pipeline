"""
Tests de performance générés automatiquement pour in_memory_cache_storage_wrapper
"""
...
try:
    ...
    def test_in_memory_cache_storage_wrapper_performance():
        """Test de performance pour in_memory_cache_storage_wrapper"""
