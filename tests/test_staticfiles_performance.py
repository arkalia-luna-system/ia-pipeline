"""
Tests de performance générés automatiquement pour staticfiles
"""
...
try:
    ...
    pytest.skip(f"Module staticfiles non importable")

    def test_staticfiles_performance():
        """Test de performance pour staticfiles"""
