"""
Tests de performance générés automatiquement pour GribStubImagePlugin
"""
...
try:
    ...
    def test_GribStubImagePlugin_performance():
        """Test de performance pour GribStubImagePlugin"""
