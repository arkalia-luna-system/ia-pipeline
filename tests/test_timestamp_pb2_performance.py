"""
Tests de performance générés automatiquement pour timestamp_pb2
"""
...
try:
    ...
    pytest.skip(f"Module timestamp_pb2 non importable")

    def test_timestamp_pb2_performance():
        """Test de performance pour timestamp_pb2"""
