"""
Tests de performance générés automatiquement pour joininggroup
"""
...
try:
    ...
    pytest.skip(f"Module joininggroup non importable")

    def test_joininggroup_performance():
        """Test de performance pour joininggroup"""
