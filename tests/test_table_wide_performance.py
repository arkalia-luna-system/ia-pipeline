"""
Tests de performance générés automatiquement pour table_wide
"""
...
try:
    ...
    pytest.skip(f"Module table_wide non importable")

    def test_table_wide_performance():
        """Test de performance pour table_wide"""
