"""
Tests de performance générés automatiquement pour ._convert_format_to_fstring
"""
...
try:
    ...
    def test_._convert_format_to_fstring_performance():
        """Test de performance pour ._convert_format_to_fstring"""
