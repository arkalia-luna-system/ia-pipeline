"""
Tests de performance générés automatiquement pour cygwinccompiler
"""
...
try:
    ...
    pytest.skip(f"Module cygwinccompiler non importable")

    def test_cygwinccompiler_performance():
        """Test de performance pour cygwinccompiler"""
