"""
Tests de performance générés automatiquement pour Video_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Video_pb2 non importable")

    def test_Video_pb2_performance():
        """Test de performance pour Video_pb2"""
