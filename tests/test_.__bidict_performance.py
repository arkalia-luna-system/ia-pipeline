"""
Tests de performance générés automatiquement pour .__bidict
"""
...
try:
    ...
    pytest.skip(f"Module .__bidict non importable")

    def test_.__bidict_performance():
        """Test de performance pour .__bidict"""
