"""
Tests de performance générés automatiquement pour ._claims
"""
...
try:
    ...
    pytest.skip(f"Module ._claims non importable")

    def test_._claims_performance():
        """Test de performance pour ._claims"""
