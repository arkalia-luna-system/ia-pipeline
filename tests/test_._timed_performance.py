"""
Tests de performance générés automatiquement pour ._timed
"""
...
try:
    ...
    pytest.skip(f"Module ._timed non importable")

    def test_._timed_performance():
        """Test de performance pour ._timed"""
