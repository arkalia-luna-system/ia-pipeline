"""
Tests de performance générés automatiquement pour _agent_instantiation
"""
...
try:
    ...
    def test__agent_instantiation_performance():
        """Test de performance pour _agent_instantiation"""
