"""
Tests de performance générés automatiquement pour Heading_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Heading_pb2 non importable")

    def test_Heading_pb2_performance():
        """Test de performance pour Heading_pb2"""
