"""
Tests de performance générés automatiquement pour ._markup
"""
...
try:
    ...
    pytest.skip(f"Module ._markup non importable")

    def test_._markup_performance():
        """Test de performance pour ._markup"""
