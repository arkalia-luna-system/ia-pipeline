"""
Tests de performance générés automatiquement pour .__wrap
"""
...
try:
    ...
    pytest.skip(f"Module .__wrap non importable")

    def test_.__wrap_performance():
        """Test de performance pour .__wrap"""
