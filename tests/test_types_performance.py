"""
Tests de performance générés automatiquement pour types
"""
...
try:
    ...
    pytest.skip(f"Module types non importable")

    def test_types_performance():
        """Test de performance pour types"""
