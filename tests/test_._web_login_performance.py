"""
Tests de performance générés automatiquement pour ._web_login
"""
...
try:
    ...
    pytest.skip(f"Module ._web_login non importable")

    def test_._web_login_performance():
        """Test de performance pour ._web_login"""
