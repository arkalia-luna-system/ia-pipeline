"""
Tests de performance générés automatiquement pour uts46data
"""
...
try:
    ...
    pytest.skip(f"Module uts46data non importable")

    def test_uts46data_performance():
        """Test de performance pour uts46data"""
