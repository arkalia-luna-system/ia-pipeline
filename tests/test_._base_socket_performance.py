"""
Tests de performance générés automatiquement pour ._base_socket
"""
...
try:
    ...
    pytest.skip(f"Module ._base_socket non importable")

    def test_._base_socket_performance():
        """Test de performance pour ._base_socket"""
