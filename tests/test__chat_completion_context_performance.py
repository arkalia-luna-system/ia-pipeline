"""
Tests de performance générés automatiquement pour _chat_completion_context
"""
...
try:
    ...
    def test__chat_completion_context_performance():
        """Test de performance pour _chat_completion_context"""
