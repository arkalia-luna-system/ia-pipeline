"""
Tests de performance générés automatiquement pour .__json
"""
...
try:
    ...
    pytest.skip(f"Module .__json non importable")

    def test_.__json_performance():
        """Test de performance pour .__json"""
