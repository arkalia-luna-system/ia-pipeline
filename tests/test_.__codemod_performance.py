"""
Tests de performance générés automatiquement pour .__codemod
"""
...
try:
    ...
    pytest.skip(f"Module .__codemod non importable")

    def test_.__codemod_performance():
        """Test de performance pour .__codemod"""
