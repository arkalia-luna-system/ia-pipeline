"""
Tests de performance générés automatiquement pour ._json
"""
...
try:
    ...
    pytest.skip(f"Module ._json non importable")

    def test_._json_performance():
        """Test de performance pour ._json"""
