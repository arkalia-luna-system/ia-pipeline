"""
Tests de performance générés automatiquement pour HeightConfig_pb2
"""
...
try:
    import HeightConfig_pb2
except ImportError:
    pytest.skip(f"Module HeightConfig_pb2 non importable")

    def test_HeightConfig_pb2_performance():
        """Test de performance pour HeightConfig_pb2"""
