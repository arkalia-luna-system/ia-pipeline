"""
Tests de performance générés automatiquement pour ._sitecustomize
"""
...
try:
    ...
    pytest.skip(f"Module ._sitecustomize non importable")

    def test_._sitecustomize_performance():
        """Test de performance pour ._sitecustomize"""
