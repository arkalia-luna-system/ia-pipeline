"""
Tests de performance générés automatiquement pour .__url
"""
...
try:
    ...
    pytest.skip(f"Module .__url non importable")

    def test_.__url_performance():
        """Test de performance pour .__url"""
