"""
Tests de performance générés automatiquement pour .__parser
"""
...
try:
    ...
    pytest.skip(f"Module .__parser non importable")

    def test_.__parser_performance():
        """Test de performance pour .__parser"""
