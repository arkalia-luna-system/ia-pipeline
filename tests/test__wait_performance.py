"""
Tests de performance générés automatiquement pour _wait
"""
...
try:
    ...
    pytest.skip(f"Module _wait non importable")

    def test__wait_performance():
        """Test de performance pour _wait"""
