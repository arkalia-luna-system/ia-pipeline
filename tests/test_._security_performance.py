"""
Tests de performance générés automatiquement pour ._security
"""
...
try:
    ...
    pytest.skip(f"Module ._security non importable")

    def test_._security_performance():
        """Test de performance pour ._security"""
