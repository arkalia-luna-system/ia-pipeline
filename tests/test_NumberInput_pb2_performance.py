"""
Tests de performance générés automatiquement pour NumberInput_pb2
"""
...
try:
    import NumberInput_pb2
except ImportError:
    pytest.skip(f"Module NumberInput_pb2 non importable")

    def test_NumberInput_pb2_performance():
        """Test de performance pour NumberInput_pb2"""
