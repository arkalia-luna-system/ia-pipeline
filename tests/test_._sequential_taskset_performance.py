"""
Tests de performance générés automatiquement pour ._sequential_taskset
"""
...
try:
    ...
    def test_._sequential_taskset_performance():
        """Test de performance pour ._sequential_taskset"""
