"""
Tests de performance générés automatiquement pour Json_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Json_pb2 non importable")

    def test_Json_pb2_performance():
        """Test de performance pour Json_pb2"""
