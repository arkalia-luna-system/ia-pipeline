"""
Tests de performance générés automatiquement pour .__partition
"""
...
try:
    ...
    pytest.skip(f"Module .__partition non importable")

    def test_.__partition_performance():
        """Test de performance pour .__partition"""
