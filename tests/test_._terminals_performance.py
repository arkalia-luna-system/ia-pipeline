"""
Tests de performance générés automatiquement pour ._terminals
"""
...
try:
    ...
    pytest.skip(f"Module ._terminals non importable")

    def test_._terminals_performance():
        """Test de performance pour ._terminals"""
