"""
Tests de performance générés automatiquement pour AuthRedirect_pb2
"""
...
try:
    import AuthRedirect_pb2
except ImportError:
    pytest.skip(f"Module AuthRedirect_pb2 non importable")

    def test_AuthRedirect_pb2_performance():
        """Test de performance pour AuthRedirect_pb2"""
