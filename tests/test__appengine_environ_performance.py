"""
Tests de performance générés automatiquement pour _appengine_environ
"""
...
try:
    ...
    def test__appengine_environ_performance():
        """Test de performance pour _appengine_environ"""
