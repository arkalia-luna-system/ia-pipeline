"""
Tests de performance générés automatiquement pour ._layout
"""
...
try:
    ...
    pytest.skip(f"Module ._layout non importable")

    def test_._layout_performance():
        """Test de performance pour ._layout"""
