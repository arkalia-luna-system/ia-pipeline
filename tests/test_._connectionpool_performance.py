"""
Tests de performance générés automatiquement pour ._connectionpool
"""
...
try:
    import ._connectionpool
except ImportError:
    pytest.skip(f"Module ._connectionpool non importable")

    def test_._connectionpool_performance():
        """Test de performance pour ._connectionpool"""
