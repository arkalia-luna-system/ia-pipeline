"""
Tests de performance générés automatiquement pour .__internal
"""
...
try:
    ...
    pytest.skip(f"Module .__internal non importable")

    def test_.__internal_performance():
        """Test de performance pour .__internal"""
