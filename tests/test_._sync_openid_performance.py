"""
Tests de performance générés automatiquement pour ._sync_openid
"""
...
try:
    ...
    pytest.skip(f"Module ._sync_openid non importable")

    def test_._sync_openid_performance():
        """Test de performance pour ._sync_openid"""
