"""
Tests de performance générés automatiquement pour plugin_pb2
"""
...
try:
    ...
    pytest.skip(f"Module plugin_pb2 non importable")

    def test_plugin_pb2_performance():
        """Test de performance pour plugin_pb2"""
