"""
Tests de performance générés automatiquement pour ._oauth2_session
"""
...
try:
    import ._oauth2_session
except ImportError:
    pytest.skip(f"Module ._oauth2_session non importable")

    def test_._oauth2_session_performance():
        """Test de performance pour ._oauth2_session"""
