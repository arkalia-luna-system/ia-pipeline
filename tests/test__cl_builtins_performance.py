"""
Tests de performance générés automatiquement pour _cl_builtins
"""
...
try:
    ...
    pytest.skip(f"Module _cl_builtins non importable")

    def test__cl_builtins_performance():
        """Test de performance pour _cl_builtins"""
