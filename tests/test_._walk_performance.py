"""
Tests de performance générés automatiquement pour ._walk
"""
...
try:
    ...
    pytest.skip(f"Module ._walk non importable")

    def test_._walk_performance():
        """Test de performance pour ._walk"""
