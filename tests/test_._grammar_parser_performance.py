"""
Tests de performance générés automatiquement pour ._grammar_parser
"""
...
try:
    import ._grammar_parser
except ImportError:
    pytest.skip(f"Module ._grammar_parser non importable")

    def test_._grammar_parser_performance():
        """Test de performance pour ._grammar_parser"""
