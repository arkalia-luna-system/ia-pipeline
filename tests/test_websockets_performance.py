"""
Tests de performance générés automatiquement pour websockets
"""
...
try:
    ...
    pytest.skip(f"Module websockets non importable")

    def test_websockets_performance():
        """Test de performance pour websockets"""
