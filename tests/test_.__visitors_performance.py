"""
Tests de performance générés automatiquement pour .__visitors
"""
...
try:
    ...
    pytest.skip(f"Module .__visitors non importable")

    def test_.__visitors_performance():
        """Test de performance pour .__visitors"""
