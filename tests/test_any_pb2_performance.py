"""
Tests de performance générés automatiquement pour any_pb2
"""
...
try:
    ...
    pytest.skip(f"Module any_pb2 non importable")

    def test_any_pb2_performance():
        """Test de performance pour any_pb2"""
