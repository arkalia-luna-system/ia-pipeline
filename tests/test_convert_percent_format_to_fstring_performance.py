"""
Tests de performance générés automatiquement pour convert_percent_format_to_fstring
"""
...
try:
    ...
    def test_convert_percent_format_to_fstring_performance():
        """Test de performance pour convert_percent_format_to_fstring"""
