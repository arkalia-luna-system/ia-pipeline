"""
Tests de performance générés automatiquement pour ._linux_driver
"""
...
try:
    import ._linux_driver
except ImportError:
    pytest.skip(f"Module ._linux_driver non importable")

    def test_._linux_driver_performance():
        """Test de performance pour ._linux_driver"""
