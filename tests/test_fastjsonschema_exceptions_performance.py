"""
Tests de performance générés automatiquement pour fastjsonschema_exceptions
"""
...
try:
    ...
    def test_fastjsonschema_exceptions_performance():
        """Test de performance pour fastjsonschema_exceptions"""
