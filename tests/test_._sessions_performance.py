"""
Tests de performance générés automatiquement pour ._sessions
"""
...
try:
    ...
    pytest.skip(f"Module ._sessions non importable")

    def test_._sessions_performance():
        """Test de performance pour ._sessions"""
