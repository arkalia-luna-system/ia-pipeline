"""
Tests de performance générés automatiquement pour ClientState_pb2
"""
...
try:
    import ClientState_pb2
except ImportError:
    pytest.skip(f"Module ClientState_pb2 non importable")

    def test_ClientState_pb2_performance():
        """Test de performance pour ClientState_pb2"""
