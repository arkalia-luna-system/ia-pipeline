"""
Tests de performance générés automatiquement pour ._index
"""
...
try:
    ...
    pytest.skip(f"Module ._index non importable")

    def test_._index_performance():
        """Test de performance pour ._index"""
