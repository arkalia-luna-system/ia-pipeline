"""
Tests de performance générés automatiquement pour _input_reader
"""
...
try:
    import _input_reader
except ImportError:
    pytest.skip(f"Module _input_reader non importable")

    def test__input_reader_performance():
        """Test de performance pour _input_reader"""
