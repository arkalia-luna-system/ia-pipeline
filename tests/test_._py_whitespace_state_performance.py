"""
Tests de performance générés automatiquement pour ._py_whitespace_state
"""
...
try:
    ...
    def test_._py_whitespace_state_performance():
        """Test de performance pour ._py_whitespace_state"""
