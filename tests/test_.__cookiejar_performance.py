"""
Tests de performance générés automatiquement pour .__cookiejar
"""
...
try:
    ...
    pytest.skip(f"Module .__cookiejar non importable")

    def test_.__cookiejar_performance():
        """Test de performance pour .__cookiejar"""
