"""
Tests de performance générés automatiquement pour LinkButton_pb2
"""
...
try:
    import LinkButton_pb2
except ImportError:
    pytest.skip(f"Module LinkButton_pb2 non importable")

    def test_LinkButton_pb2_performance():
        """Test de performance pour LinkButton_pb2"""
