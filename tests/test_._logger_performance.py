"""
Tests de performance générés automatiquement pour ._logger
"""
...
try:
    ...
    pytest.skip(f"Module ._logger non importable")

    def test_._logger_performance():
        """Test de performance pour ._logger"""
