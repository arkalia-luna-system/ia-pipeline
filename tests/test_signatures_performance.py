"""
Tests de performance générés automatiquement pour signatures
"""
...
try:
    ...
    pytest.skip(f"Module signatures non importable")

    def test_signatures_performance():
        """Test de performance pour signatures"""
