"""
Tests de performance générés automatiquement pour Slider_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Slider_pb2 non importable")

    def test_Slider_pb2_performance():
        """Test de performance pour Slider_pb2"""
