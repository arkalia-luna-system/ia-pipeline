"""
Tests de performance générés automatiquement pour zh_tw
"""
...
try:
    ...
    pytest.skip(f"Module zh_tw non importable")

    def test_zh_tw_performance():
        """Test de performance pour zh_tw"""
