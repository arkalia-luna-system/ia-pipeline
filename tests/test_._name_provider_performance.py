"""
Tests de performance générés automatiquement pour ._name_provider
"""
...
try:
    import ._name_provider
except ImportError:
    pytest.skip(f"Module ._name_provider non importable")

    def test_._name_provider_performance():
        """Test de performance pour ._name_provider"""
