"""
Tests de performance générés automatiquement pour .__add_imports
"""
...
try:
    import .__add_imports
except ImportError:
    pytest.skip(f"Module .__add_imports non importable")

    def test_.__add_imports_performance():
        """Test de performance pour .__add_imports"""
