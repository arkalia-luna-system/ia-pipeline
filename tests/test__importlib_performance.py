"""
Tests de performance générés automatiquement pour _importlib
"""
...
try:
    ...
    pytest.skip(f"Module _importlib non importable")

    def test__importlib_performance():
        """Test de performance pour _importlib"""
