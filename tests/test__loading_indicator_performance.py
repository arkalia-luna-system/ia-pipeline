"""
Tests de performance générés automatiquement pour _loading_indicator
"""
...
try:
    ...
    def test__loading_indicator_performance():
        """Test de performance pour _loading_indicator"""
