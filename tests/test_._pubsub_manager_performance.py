"""
Tests de performance générés automatiquement pour ._pubsub_manager
"""
...
try:
    import ._pubsub_manager
except ImportError:
    pytest.skip(f"Module ._pubsub_manager non importable")

    def test_._pubsub_manager_performance():
        """Test de performance pour ._pubsub_manager"""
