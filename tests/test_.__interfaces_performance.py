"""
Tests de performance générés automatiquement pour .__interfaces
"""
...
try:
    ...
    pytest.skip(f"Module .__interfaces non importable")

    def test_.__interfaces_performance():
        """Test de performance pour .__interfaces"""
