"""
Tests de performance générés automatiquement pour connection_factory
"""
...
try:
    ...
    def test_connection_factory_performance():
        """Test de performance pour connection_factory"""
