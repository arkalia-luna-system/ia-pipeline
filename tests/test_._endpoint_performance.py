"""
Tests de performance générés automatiquement pour ._endpoint
"""
...
try:
    ...
    pytest.skip(f"Module ._endpoint non importable")

    def test_._endpoint_performance():
        """Test de performance pour ._endpoint"""
