"""
Tests de performance générés automatiquement pour NamedDataSet_pb2
"""
...
try:
    import NamedDataSet_pb2
except ImportError:
    pytest.skip(f"Module NamedDataSet_pb2 non importable")

    def test_NamedDataSet_pb2_performance():
        """Test de performance pour NamedDataSet_pb2"""
