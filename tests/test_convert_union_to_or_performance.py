"""
Tests de performance générés automatiquement pour convert_union_to_or
"""
...
try:
    ...
    def test_convert_union_to_or_performance():
        """Test de performance pour convert_union_to_or"""
