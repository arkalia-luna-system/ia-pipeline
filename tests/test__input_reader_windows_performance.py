"""
Tests de performance générés automatiquement pour _input_reader_windows
"""
...
try:
    ...
    def test__input_reader_windows_performance():
        """Test de performance pour _input_reader_windows"""
