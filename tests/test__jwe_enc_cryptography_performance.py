"""
Tests de performance générés automatiquement pour _jwe_enc_cryptography
"""
...
try:
    ...
    def test__jwe_enc_cryptography_performance():
        """Test de performance pour _jwe_enc_cryptography"""
