"""
Tests de performance générés automatiquement pour .__base
"""
...
try:
    ...
    pytest.skip(f"Module .__base non importable")

    def test_.__base_performance():
        """Test de performance pour .__base"""
