"""
Tests de performance générés automatiquement pour ._oauth1_session
"""
...
try:
    import ._oauth1_session
except ImportError:
    pytest.skip(f"Module ._oauth1_session non importable")

    def test_._oauth1_session_performance():
        """Test de performance pour ._oauth1_session"""
