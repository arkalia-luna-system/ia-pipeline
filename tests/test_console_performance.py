"""
Tests de performance générés automatiquement pour console
"""
...
try:
    ...
    pytest.skip(f"Module console non importable")

    def test_console_performance():
        """Test de performance pour console"""
