"""
Tests de performance générés automatiquement pour localinterfaces
"""
...
try:
    import localinterfaces
except ImportError:
    pytest.skip(f"Module localinterfaces non importable")

    def test_localinterfaces_performance():
        """Test de performance pour localinterfaces"""
