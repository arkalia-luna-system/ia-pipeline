"""
Tests de performance générés automatiquement pour ._support
"""
...
try:
    ...
    pytest.skip(f"Module ._support non importable")

    def test_._support_performance():
        """Test de performance pour ._support"""
