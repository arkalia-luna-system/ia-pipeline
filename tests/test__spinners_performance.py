"""
Tests de performance générés automatiquement pour _spinners
"""
...
try:
    ...
    pytest.skip(f"Module _spinners non importable")

    def test__spinners_performance():
        """Test de performance pour _spinners"""
