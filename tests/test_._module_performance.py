"""
Tests de performance générés automatiquement pour ._module
"""
...
try:
    ...
    pytest.skip(f"Module ._module non importable")

    def test_._module_performance():
        """Test de performance pour ._module"""
