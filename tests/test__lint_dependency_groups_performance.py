"""
Tests de performance générés automatiquement pour _lint_dependency_groups
"""
...
try:
    ...
    def test__lint_dependency_groups_performance():
        """Test de performance pour _lint_dependency_groups"""
