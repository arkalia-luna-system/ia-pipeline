"""
Tests de performance générés automatiquement pour flight
"""
...
try:
    ...
    pytest.skip(f"Module flight non importable")

    def test_flight_performance():
        """Test de performance pour flight"""
