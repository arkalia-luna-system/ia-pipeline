"""
Tests de performance générés automatiquement pour ._blocking
"""
...
try:
    ...
    pytest.skip(f"Module ._blocking non importable")

    def test_._blocking_performance():
        """Test de performance pour ._blocking"""
