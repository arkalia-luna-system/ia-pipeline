"""
Tests de performance générés automatiquement pour deck_gl_json_chart
"""
...
try:
    ...
    def test_deck_gl_json_chart_performance():
        """Test de performance pour deck_gl_json_chart"""
