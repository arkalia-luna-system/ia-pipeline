"""
Tests de performance générés automatiquement pour ._nonce
"""
...
try:
    ...
    pytest.skip(f"Module ._nonce non importable")

    def test_._nonce_performance():
        """Test de performance pour ._nonce"""
