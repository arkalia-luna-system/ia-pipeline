"""
Tests de performance générés automatiquement pour ._reentrant_codegen
"""
...
try:
    ...
    def test_._reentrant_codegen_performance():
        """Test de performance pour ._reentrant_codegen"""
