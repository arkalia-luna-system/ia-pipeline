"""
Tests de performance générés automatiquement pour .__profile
"""
...
try:
    ...
    pytest.skip(f"Module .__profile non importable")

    def test_.__profile_performance():
        """Test de performance pour .__profile"""
