"""
Tests de performance générés automatiquement pour _gather_global_names
"""
...
try:
    ...
    def test__gather_global_names_performance():
        """Test de performance pour _gather_global_names"""
