"""
Tests de performance générés automatiquement pour validate_call_decorator
"""
...
try:
    ...
    def test_validate_call_decorator_performance():
        """Test de performance pour validate_call_decorator"""
