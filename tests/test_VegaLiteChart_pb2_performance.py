"""
Tests de performance générés automatiquement pour VegaLiteChart_pb2
"""
...
try:
    import VegaLiteChart_pb2
except ImportError:
    pytest.skip(f"Module VegaLiteChart_pb2 non importable")

    def test_VegaLiteChart_pb2_performance():
        """Test de performance pour VegaLiteChart_pb2"""
