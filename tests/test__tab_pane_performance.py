"""
Tests de performance générés automatiquement pour _tab_pane
"""
...
try:
    ...
    pytest.skip(f"Module _tab_pane non importable")

    def test__tab_pane_performance():
        """Test de performance pour _tab_pane"""
