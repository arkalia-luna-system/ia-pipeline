"""
Tests de performance générés automatiquement pour _schema_generation_shared
"""
...
try:
    ...
    def test__schema_generation_shared_performance():
        """Test de performance pour _schema_generation_shared"""
