"""
Tests de performance générés automatiquement pour unnecessary_format_string
"""
...
try:
    ...
    def test_unnecessary_format_string_performance():
        """Test de performance pour unnecessary_format_string"""
