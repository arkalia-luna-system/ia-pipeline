"""
Tests de performance générés automatiquement pour urischemes
"""
...
try:
    ...
    pytest.skip(f"Module urischemes non importable")

    def test_urischemes_performance():
        """Test de performance pour urischemes"""
