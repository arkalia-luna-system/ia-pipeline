"""
Tests de performance générés automatiquement pour ._inspectuser
"""
...
try:
    ...
    pytest.skip(f"Module ._inspectuser non importable")

    def test_._inspectuser_performance():
        """Test de performance pour ._inspectuser"""
