"""
Tests de performance générés automatiquement pour .__websocket_wsgi
"""
...
try:
    import .__websocket_wsgi
except ImportError:
    pytest.skip(f"Module .__websocket_wsgi non importable")

    def test_.__websocket_wsgi_performance():
        """Test de performance pour .__websocket_wsgi"""
