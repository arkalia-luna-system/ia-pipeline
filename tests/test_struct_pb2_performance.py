"""
Tests de performance générés automatiquement pour struct_pb2
"""
...
try:
    ...
    pytest.skip(f"Module struct_pb2 non importable")

    def test_struct_pb2_performance():
        """Test de performance pour struct_pb2"""
