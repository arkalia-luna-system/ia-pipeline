"""
Tests de performance générés automatiquement pour format_str_tokenizer
"""
...
try:
    ...
    def test_format_str_tokenizer_performance():
        """Test de performance pour format_str_tokenizer"""
