"""
Tests de performance générés automatiquement pour table_zero
"""
...
try:
    ...
    pytest.skip(f"Module table_zero non importable")

    def test_table_zero_performance():
        """Test de performance pour table_zero"""
