"""
Tests de performance générés automatiquement pour ._mqtt
"""
...
try:
    ...
    pytest.skip(f"Module ._mqtt non importable")

    def test_._mqtt_performance():
        """Test de performance pour ._mqtt"""
