"""
Tests de performance générés automatiquement pour ._sysinfo
"""
...
try:
    ...
    pytest.skip(f"Module ._sysinfo non importable")

    def test_._sysinfo_performance():
        """Test de performance pour ._sysinfo"""
