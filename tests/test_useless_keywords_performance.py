"""
Tests de performance générés automatiquement pour useless_keywords
"""
...
try:
    import useless_keywords
except ImportError:
    pytest.skip(f"Module useless_keywords non importable")

    def test_useless_keywords_performance():
        """Test de performance pour useless_keywords"""
