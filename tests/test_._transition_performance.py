"""
Tests de performance générés automatiquement pour ._transition
"""
...
try:
    ...
    pytest.skip(f"Module ._transition non importable")

    def test_._transition_performance():
        """Test de performance pour ._transition"""
