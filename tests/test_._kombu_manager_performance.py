"""
Tests de performance générés automatiquement pour ._kombu_manager
"""
...
try:
    import ._kombu_manager
except ImportError:
    pytest.skip(f"Module ._kombu_manager non importable")

    def test_._kombu_manager_performance():
        """Test de performance pour ._kombu_manager"""
