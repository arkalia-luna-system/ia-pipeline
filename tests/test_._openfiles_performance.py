"""
Tests de performance générés automatiquement pour ._openfiles
"""
...
try:
    ...
    pytest.skip(f"Module ._openfiles non importable")

    def test_._openfiles_performance():
        """Test de performance pour ._openfiles"""
