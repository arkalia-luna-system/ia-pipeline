"""
Tests de performance générés automatiquement pour .__queue
"""
...
try:
    ...
    pytest.skip(f"Module .__queue non importable")

    def test_.__queue_performance():
        """Test de performance pour .__queue"""
