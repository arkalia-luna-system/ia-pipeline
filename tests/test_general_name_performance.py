"""
Tests de performance générés automatiquement pour general_name
"""
...
try:
    ...
    pytest.skip(f"Module general_name non importable")

    def test_general_name_performance():
        """Test de performance pour general_name"""
