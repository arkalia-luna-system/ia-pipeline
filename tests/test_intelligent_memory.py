...
class TestIntelligentMemory(unittest.TestCase):
    ...
    def test_init_database(self):
        ...
        with sqlite3.connect(db_path) as conn:
            ...
            expected_tables = [
                'learning_events', 'predictions', 'correction_suggestions',
                'learned_patterns', 'learning_metrics'
            ]
    ...
    def test_get_learning_insights(self):
        ...
        expected_keys = [
            'total_events', 'total_errors', 'total_successes', 'error_rate',
            'total_patterns', 'total_predictions', 'total_corrections', 'learning_progress'
        ]
