"""
Tests de performance générés automatiquement pour dataframe_protocol
"""
...
try:
    ...
    def test_dataframe_protocol_performance():
        """Test de performance pour dataframe_protocol"""
