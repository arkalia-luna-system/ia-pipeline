"""
Tests de performance générés automatiquement pour _scheme_builtins
"""
...
try:
    import _scheme_builtins
except ImportError:
    pytest.skip(f"Module _scheme_builtins non importable")

    def test__scheme_builtins_performance():
        """Test de performance pour _scheme_builtins"""
