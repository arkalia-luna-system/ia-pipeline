"""
Tests de performance générés automatiquement pour ._apisession
"""
...
try:
    ...
    pytest.skip(f"Module ._apisession non importable")

    def test_._apisession_performance():
        """Test de performance pour ._apisession"""
