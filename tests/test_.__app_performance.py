"""
Tests de performance générés automatiquement pour .__app
"""
...
try:
    ...
    pytest.skip(f"Module .__app non importable")

    def test_.__app_performance():
        """Test de performance pour .__app"""
