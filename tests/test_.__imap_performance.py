"""
Tests de performance générés automatiquement pour .__imap
"""
...
try:
    ...
    pytest.skip(f"Module .__imap non importable")

    def test_.__imap_performance():
        """Test de performance pour .__imap"""
