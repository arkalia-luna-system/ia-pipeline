"""
Tests de performance générés automatiquement pour ._plugin
"""
...
try:
    ...
    pytest.skip(f"Module ._plugin non importable")

    def test_._plugin_performance():
        """Test de performance pour ._plugin"""
