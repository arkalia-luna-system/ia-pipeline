"""
Tests de performance générés automatiquement pour websockets_sansio_impl
"""
...
try:
    ...
    def test_websockets_sansio_impl_performance():
        """Test de performance pour websockets_sansio_impl"""
