"""
Tests de performance générés automatiquement pour ._authorization_code
"""
...
try:
    ...
    def test_._authorization_code_performance():
        """Test de performance pour ._authorization_code"""
