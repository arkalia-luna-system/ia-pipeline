"""
Tests de performance générés automatiquement pour Element_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Element_pb2 non importable")

    def test_Element_pb2_performance():
        """Test de performance pour Element_pb2"""
