"""
Tests de performance générés automatiquement pour annotated_handlers
"""
...
try:
    ...
    def test_annotated_handlers_performance():
        """Test de performance pour annotated_handlers"""
