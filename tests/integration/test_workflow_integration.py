...
class TestWorkflowIntegration:
    ...
    def workflows_dir(self):
        """Dossier des workflows (portable)."""
        return Path(__file__).resolve().parent.parent.parent / ".github" / "workflows"
    ...
    def test_ci_matrix_workflow_structure(self, workflows_dir):
        ...
        with open(ci_file, encoding="utf-8", errors="replace") as f:
            workflow = yaml.safe_load(f)

        # Vérifier les sections principales (YAML peut parser "on" comme booléen True)
