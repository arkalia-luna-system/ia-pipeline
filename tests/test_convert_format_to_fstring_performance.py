"""
Tests de performance générés automatiquement pour convert_format_to_fstring
"""
...
try:
    ...
    def test_convert_format_to_fstring_performance():
        """Test de performance pour convert_format_to_fstring"""
