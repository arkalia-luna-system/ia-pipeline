"""
Tests de performance générés automatiquement pour Arrow_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Arrow_pb2 non importable")

    def test_Arrow_pb2_performance():
        """Test de performance pour Arrow_pb2"""
