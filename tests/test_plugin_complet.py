...
def generate_test_report():
    ...
    if passed == total:
        print_status("🎉 Tous les tests sont passés ! Le plugin est prêt à être testé.", "🎉")
        print("\n📋 Prochaines étapes:")
        ...
        print_status("⚠️ Certains tests ont échoué. Vérifiez les problèmes avant de continuer.", "⚠️")
