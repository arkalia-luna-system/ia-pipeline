"""
Tests de performance générés automatiquement pour .__input_reader_windows
"""
...
try:
    ...
    def test_.__input_reader_windows_performance():
        """Test de performance pour .__input_reader_windows"""
