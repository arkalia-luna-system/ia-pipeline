"""
Tests de performance générés automatiquement pour .__button
"""
...
try:
    ...
    pytest.skip(f"Module .__button non importable")

    def test_.__button_performance():
        """Test de performance pour .__button"""
