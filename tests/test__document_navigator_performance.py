"""
Tests de performance générés automatiquement pour _document_navigator
"""
...
try:
    ...
    def test__document_navigator_performance():
        """Test de performance pour _document_navigator"""
