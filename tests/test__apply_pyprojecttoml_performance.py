"""
Tests de performance générés automatiquement pour _apply_pyprojecttoml
"""
...
try:
    ...
    def test__apply_pyprojecttoml_performance():
        """Test de performance pour _apply_pyprojecttoml"""
