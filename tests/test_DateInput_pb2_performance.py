"""
Tests de performance générés automatiquement pour DateInput_pb2
"""
...
try:
    import DateInput_pb2
except ImportError:
    pytest.skip(f"Module DateInput_pb2 non importable")

    def test_DateInput_pb2_performance():
        """Test de performance pour DateInput_pb2"""
