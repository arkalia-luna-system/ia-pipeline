"""
Tests de performance générés automatiquement pour ._paths
"""
...
try:
    ...
    pytest.skip(f"Module ._paths non importable")

    def test_._paths_performance():
        """Test de performance pour ._paths"""
