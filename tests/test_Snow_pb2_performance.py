"""
Tests de performance générés automatiquement pour Snow_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Snow_pb2 non importable")

    def test_Snow_pb2_performance():
        """Test de performance pour Snow_pb2"""
