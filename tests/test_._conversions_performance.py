"""
Tests de performance générés automatiquement pour ._conversions
"""
...
try:
    ...
    pytest.skip(f"Module ._conversions non importable")

    def test_._conversions_performance():
        """Test de performance pour ._conversions"""
