"""
Tests de performance générés automatiquement pour graphemeclusterbreak
"""
...
try:
    ...
    pytest.skip(f"Module graphemeclusterbreak non importable")

    def test_graphemeclusterbreak_performance():
        """Test de performance pour graphemeclusterbreak"""
