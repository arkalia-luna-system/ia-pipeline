"""
Tests de performance générés automatiquement pour _cocoa_builtins
"""
...
try:
    import _cocoa_builtins
except ImportError:
    pytest.skip(f"Module _cocoa_builtins non importable")

    def test__cocoa_builtins_performance():
        """Test de performance pour _cocoa_builtins"""
