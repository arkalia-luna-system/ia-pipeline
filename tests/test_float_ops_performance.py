"""
Tests de performance générés automatiquement pour float_ops
"""
...
try:
    ...
    pytest.skip(f"Module float_ops non importable")

    def test_float_ops_performance():
        """Test de performance pour float_ops"""
