"""
Tests de performance générés automatiquement pour .__wsdump
"""
...
try:
    ...
    pytest.skip(f"Module .__wsdump non importable")

    def test_.__wsdump_performance():
        """Test de performance pour .__wsdump"""
