"""
Tests de performance générés automatiquement pour ._unnecessary_format_string
"""
...
try:
    ...
    def test_._unnecessary_format_string_performance():
        """Test de performance pour ._unnecessary_format_string"""
