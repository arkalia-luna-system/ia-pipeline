"""
Tests de performance générés automatiquement pour ._leakcheck
"""
...
try:
    ...
    pytest.skip(f"Module ._leakcheck non importable")

    def test_._leakcheck_performance():
        """Test de performance pour ._leakcheck"""
