"""
Tests de performance générés automatiquement pour .__type_enforce
"""
...
try:
    import .__type_enforce
except ImportError:
    pytest.skip(f"Module .__type_enforce non importable")

    def test_.__type_enforce_performance():
        """Test de performance pour .__type_enforce"""
