"""
Tests de performance générés automatiquement pour _caller_loop
"""
...
try:
    ...
    pytest.skip(f"Module _caller_loop non importable")

    def test__caller_loop_performance():
        """Test de performance pour _caller_loop"""
