"""
Tests de performance générés automatiquement pour _stata_builtins
"""
...
try:
    import _stata_builtins
except ImportError:
    pytest.skip(f"Module _stata_builtins non importable")

    def test__stata_builtins_performance():
        """Test de performance pour _stata_builtins"""
