"""
Tests de performance générés automatiquement pour ._convert_union_to_or
"""
...
try:
    ...
    def test_._convert_union_to_or_performance():
        """Test de performance pour ._convert_union_to_or"""
