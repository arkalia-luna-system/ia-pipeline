"""
Tests de performance générés automatiquement pour remove_unused_imports
"""
...
try:
    ...
    def test_remove_unused_imports_performance():
        """Test de performance pour remove_unused_imports"""
