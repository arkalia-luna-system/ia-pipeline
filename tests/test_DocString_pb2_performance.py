"""
Tests de performance générés automatiquement pour DocString_pb2
"""
...
try:
    import DocString_pb2
except ImportError:
    pytest.skip(f"Module DocString_pb2 non importable")

    def test_DocString_pb2_performance():
        """Test de performance pour DocString_pb2"""
