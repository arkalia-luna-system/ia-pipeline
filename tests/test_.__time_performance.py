"""
Tests de performance générés automatiquement pour .__time
"""
...
try:
    ...
    pytest.skip(f"Module .__time non importable")

    def test_.__time_performance():
        """Test de performance pour .__time"""
