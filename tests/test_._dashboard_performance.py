"""
Tests de performance générés automatiquement pour ._dashboard
"""
...
try:
    ...
    pytest.skip(f"Module ._dashboard non importable")

    def test_._dashboard_performance():
        """Test de performance pour ._dashboard"""
