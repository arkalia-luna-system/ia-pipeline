"""
Tests de performance générés automatiquement pour ._gen_matcher_classes
"""
...
try:
    ...
    def test_._gen_matcher_classes_performance():
        """Test de performance pour ._gen_matcher_classes"""
