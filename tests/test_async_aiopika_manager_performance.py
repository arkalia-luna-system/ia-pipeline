"""
Tests de performance générés automatiquement pour async_aiopika_manager
"""
...
try:
    ...
    def test_async_aiopika_manager_performance():
        """Test de performance pour async_aiopika_manager"""
