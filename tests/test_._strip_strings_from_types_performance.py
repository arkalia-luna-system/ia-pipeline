"""
Tests de performance générés automatiquement pour ._strip_strings_from_types
"""
...
try:
    ...
    def test_._strip_strings_from_types_performance():
        """Test de performance pour ._strip_strings_from_types"""
