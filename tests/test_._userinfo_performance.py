"""
Tests de performance générés automatiquement pour ._userinfo
"""
...
try:
    ...
    pytest.skip(f"Module ._userinfo non importable")

    def test_._userinfo_performance():
        """Test de performance pour ._userinfo"""
