"""
Tests de performance générés automatiquement pour _lasso_builtins
"""
...
try:
    import _lasso_builtins
except ImportError:
    pytest.skip(f"Module _lasso_builtins non importable")

    def test__lasso_builtins_performance():
        """Test de performance pour _lasso_builtins"""
