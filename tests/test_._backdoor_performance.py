"""
Tests de performance générés automatiquement pour ._backdoor
"""
...
try:
    ...
    pytest.skip(f"Module ._backdoor non importable")

    def test_._backdoor_performance():
        """Test de performance pour ._backdoor"""
