"""
Tests de performance générés automatiquement pour .__orderedbase
"""
...
try:
    import .__orderedbase
except ImportError:
    pytest.skip(f"Module .__orderedbase non importable")

    def test_.__orderedbase_performance():
        """Test de performance pour .__orderedbase"""
