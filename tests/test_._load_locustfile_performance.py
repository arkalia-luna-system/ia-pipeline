"""
Tests de performance générés automatiquement pour ._load_locustfile
"""
...
try:
    import ._load_locustfile
except ImportError:
    pytest.skip(f"Module ._load_locustfile non importable")

    def test_._load_locustfile_performance():
        """Test de performance pour ._load_locustfile"""
