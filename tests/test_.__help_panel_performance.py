"""
Tests de performance générés automatiquement pour .__help_panel
"""
...
try:
    ...
    pytest.skip(f"Module .__help_panel non importable")

    def test_.__help_panel_performance():
        """Test de performance pour .__help_panel"""
