"""
Tests de performance générés automatiquement pour read_directory_changes
"""
...
try:
    ...
    def test_read_directory_changes_performance():
        """Test de performance pour read_directory_changes"""
