"""
Tests de performance générés automatiquement pour ._autocomplete_server
"""
...
try:
    ...
    def test_._autocomplete_server_performance():
        """Test de performance pour ._autocomplete_server"""
