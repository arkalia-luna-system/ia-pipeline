"""
Tests de performance générés automatiquement pour ._aiows
"""
...
try:
    ...
    pytest.skip(f"Module ._aiows non importable")

    def test_._aiows_performance():
        """Test de performance pour ._aiows"""
