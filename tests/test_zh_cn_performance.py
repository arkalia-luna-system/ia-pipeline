"""
Tests de performance générés automatiquement pour zh_cn
"""
...
try:
    ...
    pytest.skip(f"Module zh_cn non importable")

    def test_zh_cn_performance():
        """Test de performance pour zh_cn"""
