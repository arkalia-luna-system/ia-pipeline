"""
Tests de performance générés automatiquement pour ._profiler
"""
...
try:
    ...
    pytest.skip(f"Module ._profiler non importable")

    def test_._profiler_performance():
        """Test de performance pour ._profiler"""
