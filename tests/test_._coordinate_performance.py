"""
Tests de performance générés automatiquement pour ._coordinate
"""
...
try:
    ...
    pytest.skip(f"Module ._coordinate non importable")

    def test_._coordinate_performance():
        """Test de performance pour ._coordinate"""
