"""
Tests de performance générés automatiquement pour generalcategory
"""
...
try:
    ...
    pytest.skip(f"Module generalcategory non importable")

    def test_generalcategory_performance():
        """Test de performance pour generalcategory"""
