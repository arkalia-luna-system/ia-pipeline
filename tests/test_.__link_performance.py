"""
Tests de performance générés automatiquement pour .__link
"""
...
try:
    ...
    pytest.skip(f"Module .__link non importable")

    def test_.__link_performance():
        """Test de performance pour .__link"""
