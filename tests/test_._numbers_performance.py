"""
Tests de performance générés automatiquement pour ._numbers
"""
...
try:
    ...
    pytest.skip(f"Module ._numbers non importable")

    def test_._numbers_performance():
        """Test de performance pour ._numbers"""
