"""
Tests de performance générés automatiquement pour _known_annotated_metadata
"""
...
try:
    ...
    def test__known_annotated_metadata_performance():
        """Test de performance pour _known_annotated_metadata"""
