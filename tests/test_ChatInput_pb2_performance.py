"""
Tests de performance générés automatiquement pour ChatInput_pb2
"""
...
try:
    import ChatInput_pb2
except ImportError:
    pytest.skip(f"Module ChatInput_pb2 non importable")

    def test_ChatInput_pb2_performance():
        """Test de performance pour ChatInput_pb2"""
