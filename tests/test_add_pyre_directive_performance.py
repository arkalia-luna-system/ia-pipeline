"""
Tests de performance générés automatiquement pour add_pyre_directive
"""
...
try:
    ...
    def test_add_pyre_directive_performance():
        """Test de performance pour add_pyre_directive"""
