"""
Tests de performance générés automatiquement pour other
"""
...
try:
    ...
    pytest.skip(f"Module other non importable")

    def test_other_performance():
        """Test de performance pour other"""
