"""
Tests de performance générés automatiquement pour authorization_server
"""
...
try:
    ...
    def test_authorization_server_performance():
        """Test de performance pour authorization_server"""
