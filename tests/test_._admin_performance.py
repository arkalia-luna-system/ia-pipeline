"""
Tests de performance générés automatiquement pour ._admin
"""
...
try:
    ...
    pytest.skip(f"Module ._admin non importable")

    def test_._admin_performance():
        """Test de performance pour ._admin"""
