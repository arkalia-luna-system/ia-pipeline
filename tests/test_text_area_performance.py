"""
Tests de performance générés automatiquement pour text_area
"""
...
try:
    ...
    pytest.skip(f"Module text_area non importable")

    def test_text_area_performance():
        """Test de performance pour text_area"""
