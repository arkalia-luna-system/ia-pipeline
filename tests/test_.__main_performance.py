"""
Tests de performance générés automatiquement pour .__main
"""
...
try:
    ...
    pytest.skip(f"Module .__main non importable")

    def test_.__main_performance():
        """Test de performance pour .__main"""
