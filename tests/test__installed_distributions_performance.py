"""
Tests de performance générés automatiquement pour _installed_distributions
"""
...
try:
    ...
    def test__installed_distributions_performance():
        """Test de performance pour _installed_distributions"""
