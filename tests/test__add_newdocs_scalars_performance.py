"""
Tests de performance générés automatiquement pour _add_newdocs_scalars
"""
...
try:
    ...
    def test__add_newdocs_scalars_performance():
        """Test de performance pour _add_newdocs_scalars"""
