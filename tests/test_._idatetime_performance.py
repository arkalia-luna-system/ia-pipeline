"""
Tests de performance générés automatiquement pour ._idatetime
"""
...
try:
    ...
    pytest.skip(f"Module ._idatetime non importable")

    def test_._idatetime_performance():
        """Test de performance pour ._idatetime"""
