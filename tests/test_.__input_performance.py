"""
Tests de performance générés automatiquement pour .__input
"""
...
try:
    ...
    pytest.skip(f"Module .__input non importable")

    def test_.__input_performance():
        """Test de performance pour .__input"""
