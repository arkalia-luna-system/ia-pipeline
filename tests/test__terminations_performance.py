"""
Tests de performance générés automatiquement pour _terminations
"""
...
try:
    import _terminations
except ImportError:
    pytest.skip(f"Module _terminations non importable")

    def test__terminations_performance():
        """Test de performance pour _terminations"""
