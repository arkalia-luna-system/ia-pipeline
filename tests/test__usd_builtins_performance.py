"""
Tests de performance générés automatiquement pour _usd_builtins
"""
...
try:
    import _usd_builtins
except ImportError:
    pytest.skip(f"Module _usd_builtins non importable")

    def test__usd_builtins_performance():
        """Test de performance pour _usd_builtins"""
