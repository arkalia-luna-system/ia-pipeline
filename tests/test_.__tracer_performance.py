"""
Tests de performance générés automatiquement pour .__tracer
"""
...
try:
    ...
    pytest.skip(f"Module .__tracer non importable")

    def test_.__tracer_performance():
        """Test de performance pour .__tracer"""
