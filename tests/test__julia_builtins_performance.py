"""
Tests de performance générés automatiquement pour _julia_builtins
"""
...
try:
    import _julia_builtins
except ImportError:
    pytest.skip(f"Module _julia_builtins non importable")

    def test__julia_builtins_performance():
        """Test de performance pour _julia_builtins"""
