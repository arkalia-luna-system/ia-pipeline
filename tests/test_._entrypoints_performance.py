"""
Tests de performance générés automatiquement pour ._entrypoints
"""
...
try:
    ...
    pytest.skip(f"Module ._entrypoints non importable")

    def test_._entrypoints_performance():
        """Test de performance pour ._entrypoints"""
