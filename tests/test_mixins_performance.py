"""
Tests de performance générés automatiquement pour mixins
"""
...
try:
    ...
    pytest.skip(f"Module mixins non importable")

    def test_mixins_performance():
        """Test de performance pour mixins"""
