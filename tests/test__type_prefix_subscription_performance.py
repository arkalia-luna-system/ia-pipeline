"""
Tests de performance générés automatiquement pour _type_prefix_subscription
"""
...
try:
    ...
    def test__type_prefix_subscription_performance():
        """Test de performance pour _type_prefix_subscription"""
