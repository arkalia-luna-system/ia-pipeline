...
def test_function_generate_project_exists():
    ...
    assert callable(module.generate_project)
...
def test_function_raise_athalia_error_exists():
    ...
    assert callable(module.raise_athalia_error)
...
def test_class_AutoCICD_exists():
    ...
    assert inspect.isclass(module.AutoCICD)
