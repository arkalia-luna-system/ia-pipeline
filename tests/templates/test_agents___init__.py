# Template de test pour athalia_core/agents/__init__.py
# Fichier: tests/test_agents___init__.py

import pytest
import athalia_core.agents.__init__ as module


class Test__Init__:
    """Tests pour le module agents.__init__"""
