# Template de test pour athalia_core/distillation/__init__.py
# Fichier: tests/test_distillation___init__.py

import pytest
import athalia_core.distillation.__init__ as module

class Test__Init__:
    """Tests pour le module distillation.__init__"""
