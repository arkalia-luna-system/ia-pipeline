"""
Tests de performance générés automatiquement pour .__waiter
"""
...
try:
    ...
    pytest.skip(f"Module .__waiter non importable")

    def test_.__waiter_performance():
        """Test de performance pour .__waiter"""
