"""
Tests de performance générés automatiquement pour _postgres_builtins
"""
...
try:
    ...
    def test__postgres_builtins_performance():
        """Test de performance pour _postgres_builtins"""
