"""
Tests de performance générés automatiquement pour Progress_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Progress_pb2 non importable")

    def test_Progress_pb2_performance():
        """Test de performance pour Progress_pb2"""
