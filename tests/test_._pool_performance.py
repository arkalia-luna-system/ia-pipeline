"""
Tests de performance générés automatiquement pour ._pool
"""
...
try:
    ...
    pytest.skip(f"Module ._pool non importable")

    def test_._pool_performance():
        """Test de performance pour ._pool"""
