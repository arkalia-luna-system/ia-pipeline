"""
Tests de performance générés automatiquement pour duration_pb2
"""
...
try:
    ...
    pytest.skip(f"Module duration_pb2 non importable")

    def test_duration_pb2_performance():
        """Test de performance pour duration_pb2"""
