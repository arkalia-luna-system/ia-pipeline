"""
Tests de performance générés automatiquement pour eastasianwidth
"""
...
try:
    ...
    pytest.skip(f"Module eastasianwidth non importable")

    def test_eastasianwidth_performance():
        """Test de performance pour eastasianwidth"""
