"""
Tests de performance générés automatiquement pour .__work_decorator
"""
...
try:
    import .__work_decorator
except ImportError:
    pytest.skip(f"Module .__work_decorator non importable")

    def test_.__work_decorator_performance():
        """Test de performance pour .__work_decorator"""
