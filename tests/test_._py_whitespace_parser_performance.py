"""
Tests de performance générés automatiquement pour ._py_whitespace_parser
"""
...
try:
    ...
    def test_._py_whitespace_parser_performance():
        """Test de performance pour ._py_whitespace_parser"""
