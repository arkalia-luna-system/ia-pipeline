"""
Tests de performance générés automatiquement pour decompositiontype
"""
...
try:
    ...
    pytest.skip(f"Module decompositiontype non importable")

    def test_decompositiontype_performance():
        """Test de performance pour decompositiontype"""
