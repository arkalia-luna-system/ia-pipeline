"""
Tests de performance générés automatiquement pour convert_namedtuple_to_dataclass
"""
...
try:
    ...
    def test_convert_namedtuple_to_dataclass_performance():
        """Test de performance pour convert_namedtuple_to_dataclass"""
