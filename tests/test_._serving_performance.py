"""
Tests de performance générés automatiquement pour ._serving
"""
...
try:
    ...
    pytest.skip(f"Module ._serving non importable")

    def test_._serving_performance():
        """Test de performance pour ._serving"""
