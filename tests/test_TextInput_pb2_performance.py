"""
Tests de performance générés automatiquement pour TextInput_pb2
"""
...
try:
    import TextInput_pb2
except ImportError:
    pytest.skip(f"Module TextInput_pb2 non importable")

    def test_TextInput_pb2_performance():
        """Test de performance pour TextInput_pb2"""
