"""
Tests de performance générés automatiquement pour _identifier
"""
...
try:
    ...
    pytest.skip(f"Module _identifier non importable")

    def test__identifier_performance():
        """Test de performance pour _identifier"""
