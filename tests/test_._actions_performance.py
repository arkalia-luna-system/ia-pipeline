"""
Tests de performance générés automatiquement pour ._actions
"""
...
try:
    ...
    pytest.skip(f"Module ._actions non importable")

    def test_._actions_performance():
        """Test de performance pour ._actions"""
