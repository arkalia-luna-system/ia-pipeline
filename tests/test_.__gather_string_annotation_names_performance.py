"""
Tests de performance générés automatiquement pour .__gather_string_annotation_names
"""
...
try:
    ...
    def test_.__gather_string_annotation_names_performance():
        """Test de performance pour .__gather_string_annotation_names"""
