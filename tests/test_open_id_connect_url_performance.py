"""
Tests de performance générés automatiquement pour open_id_connect_url
"""
...
try:
    ...
    def test_open_id_connect_url_performance():
        """Test de performance pour open_id_connect_url"""
