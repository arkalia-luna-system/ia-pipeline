"""
Tests de performance générés automatiquement pour FileUploader_pb2
"""
...
try:
    import FileUploader_pb2
except ImportError:
    pytest.skip(f"Module FileUploader_pb2 non importable")

    def test_FileUploader_pb2_performance():
        """Test de performance pour FileUploader_pb2"""
