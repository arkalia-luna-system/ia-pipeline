"""
Tests de performance générés automatiquement pour ._stats
"""
...
try:
    ...
    pytest.skip(f"Module ._stats non importable")

    def test_._stats_performance():
        """Test de performance pour ._stats"""
