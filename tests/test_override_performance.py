"""
Tests de performance générés automatiquement pour override
"""
...
try:
    ...
    pytest.skip(f"Module override non importable")

    def test_override_performance():
        """Test de performance pour override"""
