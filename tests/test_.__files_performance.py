"""
Tests de performance générés automatiquement pour .__files
"""
...
try:
    ...
    pytest.skip(f"Module .__files non importable")

    def test_.__files_performance():
        """Test de performance pour .__files"""
