"""
Tests de performance générés automatiquement pour ._shared_data
"""
...
try:
    ...
    pytest.skip(f"Module ._shared_data non importable")

    def test_._shared_data_performance():
        """Test de performance pour ._shared_data"""
