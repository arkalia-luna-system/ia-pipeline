"""
Tests de performance générés automatiquement pour PageProfile_pb2
"""
...
try:
    import PageProfile_pb2
except ImportError:
    pytest.skip(f"Module PageProfile_pb2 non importable")

    def test_PageProfile_pb2_performance():
        """Test de performance pour PageProfile_pb2"""
