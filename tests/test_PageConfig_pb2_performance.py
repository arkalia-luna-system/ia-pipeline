"""
Tests de performance générés automatiquement pour PageConfig_pb2
"""
...
try:
    import PageConfig_pb2
except ImportError:
    pytest.skip(f"Module PageConfig_pb2 non importable")

    def test_PageConfig_pb2_performance():
        """Test de performance pour PageConfig_pb2"""
