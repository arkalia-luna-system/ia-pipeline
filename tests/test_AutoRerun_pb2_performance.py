"""
Tests de performance générés automatiquement pour AutoRerun_pb2
"""
...
try:
    import AutoRerun_pb2
except ImportError:
    pytest.skip(f"Module AutoRerun_pb2 non importable")

    def test_AutoRerun_pb2_performance():
        """Test de performance pour AutoRerun_pb2"""
