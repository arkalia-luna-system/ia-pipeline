"""
Tests de performance générés automatiquement pour ._interface
"""
...
try:
    ...
    pytest.skip(f"Module ._interface non importable")

    def test_._interface_performance():
        """Test de performance pour ._interface"""
