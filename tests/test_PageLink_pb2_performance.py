"""
Tests de performance générés automatiquement pour PageLink_pb2
"""
...
try:
    ...
    pytest.skip(f"Module PageLink_pb2 non importable")

    def test_PageLink_pb2_performance():
        """Test de performance pour PageLink_pb2"""
