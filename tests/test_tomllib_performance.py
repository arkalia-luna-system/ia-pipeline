"""
Tests de performance générés automatiquement pour tomllib
"""
...
try:
    ...
    pytest.skip(f"Module tomllib non importable")

    def test_tomllib_performance():
        """Test de performance pour tomllib"""
