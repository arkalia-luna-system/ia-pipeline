"""
Tests de performance générés automatiquement pour ._declarations
"""
...
try:
    ...
    pytest.skip(f"Module ._declarations non importable")

    def test_._declarations_performance():
        """Test de performance pour ._declarations"""
