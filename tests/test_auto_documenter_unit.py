...
class TestAutoDocumenter(unittest.TestCase):
    def setUp(self):
        ...
        self.documenter.project_info = {
            ...
            'modules': [
                {
                    ...
                    'classes': [
                        {'name': 'MainClass', 'docstring': 'Classe principale', 'methods': ['run', 'stop']}
                    ],
                    'functions': [
                        {'name': 'run', 'docstring': 'Lance le module', 'args': ['config']}
                    ]
                },
                {
                    'name': 'api',
            ...
            'classes': [
                {'name': 'MainClass', 'docstring': 'Classe principale', 'methods': ['run', 'stop']},
                {'name': 'HelperClass', 'docstring': 'Classe utilitaire', 'methods': ['help']}
            ],
            'functions': [
