"""
Tests de performance générés automatiquement pour ._graphite
"""
...
try:
    ...
    pytest.skip(f"Module ._graphite non importable")

    def test_._graphite_performance():
        """Test de performance pour ._graphite"""
