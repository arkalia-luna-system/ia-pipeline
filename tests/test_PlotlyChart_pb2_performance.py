"""
Tests de performance générés automatiquement pour PlotlyChart_pb2
"""
...
try:
    import PlotlyChart_pb2
except ImportError:
    pytest.skip(f"Module PlotlyChart_pb2 non importable")

    def test_PlotlyChart_pb2_performance():
        """Test de performance pour PlotlyChart_pb2"""
