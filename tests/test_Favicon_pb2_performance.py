"""
Tests de performance générés automatiquement pour Favicon_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Favicon_pb2 non importable")

    def test_Favicon_pb2_performance():
        """Test de performance pour Favicon_pb2"""
