"""
Tests de performance générés automatiquement pour WidthConfig_pb2
"""
...
try:
    import WidthConfig_pb2
except ImportError:
    pytest.skip(f"Module WidthConfig_pb2 non importable")

    def test_WidthConfig_pb2_performance():
        """Test de performance pour WidthConfig_pb2"""
