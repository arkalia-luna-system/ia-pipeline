"""
Tests de performance générés automatiquement pour GraphVizChart_pb2
"""
...
try:
    import GraphVizChart_pb2
except ImportError:
    pytest.skip(f"Module GraphVizChart_pb2 non importable")

    def test_GraphVizChart_pb2_performance():
        """Test de performance pour GraphVizChart_pb2"""
