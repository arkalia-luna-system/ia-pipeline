"""
Tests de performance générés automatiquement pour ._containers
"""
...
try:
    ...
    pytest.skip(f"Module ._containers non importable")

    def test_._containers_performance():
        """Test de performance pour ._containers"""
