"""
Tests de performance générés automatiquement pour .__markdown
"""
...
try:
    ...
    pytest.skip(f"Module .__markdown non importable")

    def test_.__markdown_performance():
        """Test de performance pour .__markdown"""
