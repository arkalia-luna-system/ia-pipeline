"""
Tests de performance générés automatiquement pour .__xterm_parser
"""
...
try:
    import .__xterm_parser
except ImportError:
    pytest.skip(f"Module .__xterm_parser non importable")

    def test_.__xterm_parser_performance():
        """Test de performance pour .__xterm_parser"""
