"""
Tests de performance générés automatiquement pour .__data_table
"""
...
try:
    ...
    pytest.skip(f"Module .__data_table non importable")

    def test_.__data_table_performance():
        """Test de performance pour .__data_table"""
