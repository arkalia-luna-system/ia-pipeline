"""
Tests de performance générés automatiquement pour lexers
"""
...
try:
    ...
    pytest.skip(f"Module lexers non importable")

    def test_lexers_performance():
        """Test de performance pour lexers"""
