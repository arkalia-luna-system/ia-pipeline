"""
Tests de performance générés automatiquement pour _chat_agent_container
"""
...
try:
    ...
    def test__chat_agent_container_performance():
        """Test de performance pour _chat_agent_container"""
