"""
Tests de performance générés automatiquement pour ._full_repo_manager
"""
...
try:
    ...
    def test_._full_repo_manager_performance():
        """Test de performance pour ._full_repo_manager"""
