"""
Tests de performance générés automatiquement pour Metric_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Metric_pb2 non importable")

    def test_Metric_pb2_performance():
        """Test de performance pour Metric_pb2"""
