"""
Tests de performance générés automatiquement pour .__static
"""
...
try:
    ...
    pytest.skip(f"Module .__static non importable")

    def test_.__static_performance():
        """Test de performance pour .__static"""
