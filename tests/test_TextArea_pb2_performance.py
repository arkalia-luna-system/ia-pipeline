"""
Tests de performance générés automatiquement pour TextArea_pb2
"""
...
try:
    ...
    pytest.skip(f"Module TextArea_pb2 non importable")

    def test_TextArea_pb2_performance():
        """Test de performance pour TextArea_pb2"""
