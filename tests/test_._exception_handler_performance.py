"""
Tests de performance générés automatiquement pour ._exception_handler
"""
...
try:
    ...
    def test_._exception_handler_performance():
        """Test de performance pour ._exception_handler"""
