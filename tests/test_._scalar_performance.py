"""
Tests de performance générés automatiquement pour ._scalar
"""
...
try:
    ...
    pytest.skip(f"Module ._scalar non importable")

    def test_._scalar_performance():
        """Test de performance pour ._scalar"""
