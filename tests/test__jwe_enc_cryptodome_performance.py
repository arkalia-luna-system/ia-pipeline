"""
Tests de performance générés automatiquement pour _jwe_enc_cryptodome
"""
...
try:
    ...
    def test__jwe_enc_cryptodome_performance():
        """Test de performance pour _jwe_enc_cryptodome"""
