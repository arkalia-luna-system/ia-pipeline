"""
Tests de performance générés automatiquement pour .__gather_comments
"""
...
try:
    import .__gather_comments
except ImportError:
    pytest.skip(f"Module .__gather_comments non importable")

    def test_.__gather_comments_performance():
        """Test de performance pour .__gather_comments"""
