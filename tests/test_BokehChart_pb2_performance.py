"""
Tests de performance générés automatiquement pour BokehChart_pb2
"""
...
try:
    import BokehChart_pb2
except ImportError:
    pytest.skip(f"Module BokehChart_pb2 non importable")

    def test_BokehChart_pb2_performance():
        """Test de performance pour BokehChart_pb2"""
