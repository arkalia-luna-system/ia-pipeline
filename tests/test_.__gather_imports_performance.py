"""
Tests de performance générés automatiquement pour .__gather_imports
"""
...
try:
    import .__gather_imports
except ImportError:
    pytest.skip(f"Module .__gather_imports non importable")

    def test_.__gather_imports_performance():
        """Test de performance pour .__gather_imports"""
