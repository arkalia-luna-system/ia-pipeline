"""
Tests de performance générés automatiquement pour extending_distributions
"""
...
try:
    ...
    def test_extending_distributions_performance():
        """Test de performance pour extending_distributions"""
