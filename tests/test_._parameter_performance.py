"""
Tests de performance générés automatiquement pour ._parameter
"""
...
try:
    ...
    pytest.skip(f"Module ._parameter non importable")

    def test_._parameter_performance():
        """Test de performance pour ._parameter"""
