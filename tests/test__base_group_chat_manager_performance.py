"""
Tests de performance générés automatiquement pour _base_group_chat_manager
"""
...
try:
    ...
    def test__base_group_chat_manager_performance():
        """Test de performance pour _base_group_chat_manager"""
