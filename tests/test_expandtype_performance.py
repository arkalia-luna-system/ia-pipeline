"""
Tests de performance générés automatiquement pour expandtype
"""
...
try:
    ...
    pytest.skip(f"Module expandtype non importable")

    def test_expandtype_performance():
        """Test de performance pour expandtype"""
