"""
Tests de performance générés automatiquement pour Code_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Code_pb2 non importable")

    def test_Code_pb2_performance():
        """Test de performance pour Code_pb2"""
