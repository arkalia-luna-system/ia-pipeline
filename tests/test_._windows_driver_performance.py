"""
Tests de performance générés automatiquement pour ._windows_driver
"""
...
try:
    import ._windows_driver
except ImportError:
    pytest.skip(f"Module ._windows_driver non importable")

    def test_._windows_driver_performance():
        """Test de performance pour ._windows_driver"""
