"""
Tests de performance générés automatiquement pour ._middleware
"""
...
try:
    ...
    pytest.skip(f"Module ._middleware non importable")

    def test_._middleware_performance():
        """Test de performance pour ._middleware"""
