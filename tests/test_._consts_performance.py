"""
Tests de performance générés automatiquement pour ._consts
"""
...
try:
    ...
    pytest.skip(f"Module ._consts non importable")

    def test_._consts_performance():
        """Test de performance pour ._consts"""
