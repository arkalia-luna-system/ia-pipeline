"""
Tests de performance générés automatiquement pour _digest_auth_compat
"""
...
try:
    ...
    def test__digest_auth_compat_performance():
        """Test de performance pour _digest_auth_compat"""
