"""
Tests de performance générés automatiquement pour expression_context_provider
"""
...
try:
    ...
    def test_expression_context_provider_performance():
        """Test de performance pour expression_context_provider"""
