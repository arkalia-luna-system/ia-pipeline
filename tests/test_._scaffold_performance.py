"""
Tests de performance générés automatiquement pour ._scaffold
"""
...
try:
    ...
    pytest.skip(f"Module ._scaffold non importable")

    def test_._scaffold_performance():
        """Test de performance pour ._scaffold"""
