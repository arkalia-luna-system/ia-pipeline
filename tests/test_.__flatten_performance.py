"""
Tests de performance générés automatiquement pour .__flatten
"""
...
try:
    ...
    pytest.skip(f"Module .__flatten non importable")

    def test_.__flatten_performance():
        """Test de performance pour .__flatten"""
