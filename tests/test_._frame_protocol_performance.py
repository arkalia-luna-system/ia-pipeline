"""
Tests de performance générés automatiquement pour ._frame_protocol
"""
...
try:
    import ._frame_protocol
except ImportError:
    pytest.skip(f"Module ._frame_protocol non importable")

    def test_._frame_protocol_performance():
        """Test de performance pour ._frame_protocol"""
