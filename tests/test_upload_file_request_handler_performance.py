"""
Tests de performance générés automatiquement pour upload_file_request_handler
"""
...
try:
    ...
    def test_upload_file_request_handler_performance():
        """Test de performance pour upload_file_request_handler"""
