"""
Tests de performance générés automatiquement pour ._expression_context_provider
"""
...
try:
    ...
    def test_._expression_context_provider_performance():
        """Test de performance pour ._expression_context_provider"""
