"""
Tests de performance générés automatiquement pour Html_pb2
"""
...
try:
    ...
    pytest.skip(f"Module Html_pb2 non importable")

    def test_Html_pb2_performance():
        """Test de performance pour Html_pb2"""
