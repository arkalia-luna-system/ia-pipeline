"""
Tests de performance générés automatiquement pour export_docker_plugin
"""
...
try:
    ...
    def test_export_docker_plugin_performance():
        """Test de performance pour export_docker_plugin"""
