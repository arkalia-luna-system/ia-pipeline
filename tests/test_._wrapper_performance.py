"""
Tests de performance générés automatiquement pour ._wrapper
"""
...
try:
    ...
    pytest.skip(f"Module ._wrapper non importable")

    def test_._wrapper_performance():
        """Test de performance pour ._wrapper"""
