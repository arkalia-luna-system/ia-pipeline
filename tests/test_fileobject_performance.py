"""
Tests de performance générés automatiquement pour fileobject
"""
...
try:
    ...
    pytest.skip(f"Module fileobject non importable")

    def test_fileobject_performance():
        """Test de performance pour fileobject"""
