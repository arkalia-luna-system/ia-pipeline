"""
Tests de performance générés automatiquement pour accept
"""
...
try:
    ...
    pytest.skip(f"Module accept non importable")

    def test_accept_performance():
        """Test de performance pour accept"""
