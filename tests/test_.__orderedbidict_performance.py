"""
Tests de performance générés automatiquement pour .__orderedbidict
"""
...
try:
    import .__orderedbidict
except ImportError:
    pytest.skip(f"Module .__orderedbidict non importable")

    def test_.__orderedbidict_performance():
        """Test de performance pour .__orderedbidict"""
