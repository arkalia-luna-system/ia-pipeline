"""
Tests de performance générés automatiquement pour _compute_docstrings
"""
...
try:
    ...
    def test__compute_docstrings_performance():
        """Test de performance pour _compute_docstrings"""
