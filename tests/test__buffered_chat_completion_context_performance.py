"""
Tests de performance générés automatiquement pour _buffered_chat_completion_context
"""
...
try:
    ...
    def test__buffered_chat_completion_context_performance():
        """Test de performance pour _buffered_chat_completion_context"""
