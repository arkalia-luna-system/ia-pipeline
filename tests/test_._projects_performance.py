"""
Tests de performance générés automatiquement pour ._projects
"""
...
try:
    ...
    pytest.skip(f"Module ._projects non importable")

    def test_._projects_performance():
        """Test de performance pour ._projects"""
