"""
Tests de performance générés automatiquement pour ._text_opacity
"""
...
try:
    import ._text_opacity
except ImportError:
    pytest.skip(f"Module ._text_opacity non importable")

    def test_._text_opacity_performance():
        """Test de performance pour ._text_opacity"""
