"""
Tests de performance générés automatiquement pour SessionStatus_pb2
"""
...
try:
    import SessionStatus_pb2
except ImportError:
    pytest.skip(f"Module SessionStatus_pb2 non importable")

    def test_SessionStatus_pb2_performance():
        """Test de performance pour SessionStatus_pb2"""
