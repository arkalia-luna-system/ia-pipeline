"""
Tests de performance générés automatiquement pour AppPage_pb2
"""
...
try:
    ...
    pytest.skip(f"Module AppPage_pb2 non importable")

    def test_AppPage_pb2_performance():
        """Test de performance pour AppPage_pb2"""
