"""
Tests de performance générés automatiquement pour ._screen
"""
...
try:
    ...
    pytest.skip(f"Module ._screen non importable")

    def test_._screen_performance():
        """Test de performance pour ._screen"""
