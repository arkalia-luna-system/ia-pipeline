...
def test_ath_dev_boost():
    ...
    assert "" in result.stdout or "" in result.stdout.lower(), "ath-dev-boost.sh ne fonctionne pas"
...
def test_ath_context_prompt():
    ...
    assert "" in result.stdout or "" in result.stdout.lower(), "ath_context_prompt.py ne fonctionne pas"
...
def test_alias_sh():
    ...
    # Adapter ici selon le contenu réel de alias.sh
    aliases = [
        "ath-dev-boost",
        "athalia-run",
        "athalia-clean",
