            ...
            if not os.path.exists(path):
                ...
                if not dry_run:
                    with open(path, 'w') as file_handle:
                        file_handle.write(f"# {item} généré automatiquement\n")
