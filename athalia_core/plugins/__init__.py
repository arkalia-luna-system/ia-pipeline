...
try:
    ...
    ExportDockerPlugin = type("ExportDockerPlugin", (), {
        "run": staticmethod(docker_run),
        "get_info": staticmethod(docker_info)
    })
except ImportError:
...
try:
    ...
    HelloPlugin = type("HelloPlugin", (), {
        "run": staticmethod(hello_run),
        "get_info": staticmethod(hello_info)
    })
except ImportError:
    HelloPlugin = None
...
try:
    ...
    PluginsManager = type("PluginsManager", (), {
...
try:
    ...
    PluginsValidator = type("PluginsValidator", (), {
        "validate_plugin": staticmethod(validate_plugin)
    })
except ImportError:
