...
class ASTAnalyzer:
    ...
    def _extract_functions(self, tree: ast.AST, content: str, file_path: Path) -> List[ASTNodeInfo]:
    ...
    def _extract_classes(self, tree: ast.AST, content: str, file_path: Path) -> List[ASTNodeInfo]:
    ...
    def _extract_conditionals(self, tree: ast.AST, content: str, file_path: Path) -> List[ASTNodeInfo]:
    ...
    def _extract_loops(self, tree: ast.AST, content: str, file_path: Path) -> List[ASTNodeInfo]:
    ...
    def _calculate_complexity(self, tree: ast.AST) -> float:
        ...
        for node in ast.walk(tree):
            if isinstance(node, (ast.FunctionDef, ast.ClassDef, ast.If, ast.While, ast.For)):
