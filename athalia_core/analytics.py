"""
Module d'analytics IA pour visualisations avancées.
"""
...
'''
    ...
    <script>
        ...
        new Chart(heatmapCtx, {
            type: 'bar',
            data: {
                labels: ''' + str(heatmap_data['labels']) + ''',
                datasets: [{
                    label: 'Score global',
                    data: ''' + str([d['global_score'] for d in heatmap_data['datasets']]) + ''',
                    ...
                    borderColor: function(context) {
                        ...
                        if (value >= 40) return 'rgba(253, 126, 20, 1)';
        ...
        new Chart(issuesCtx, {
            type: 'doughnut',
            data: {
                labels: ''' + str(list(debt_analysis['common_issues'].keys())) + ''',
                datasets: [{
                    data: ''' + str(list(debt_analysis['common_issues'].values())) + ''',
                    backgroundColor: [
                        'rgba(255, 99, 132, 0.8)',
                        'rgba(54, 162, 235, 0.8)',
                        'rgba(255, 206, 86, 0.8)',
