...
class IntelligentMemory:
    ...
    def get_learning_insights(self) -> Dict[str, Any]:
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            prediction_accuracy = correct_predictions / \
                validated_predictions if validated_predictions > 0 else 0
            correction_success_rate = successful_corrections / \
                applied_corrections if applied_corrections > 0 else 0
