...
class NavigationValidator:
    ...
    def run_navigation_test(self):
        """Exécute le test de navigation intelligent"""
        print("🔍 Exécution du test de navigation intelligent...")
        try:
            ...
            if result.returncode == 0:
                print("✅ Test de navigation exécuté avec succès")
                return self.parse_navigation_results()
            else:
                print(f"❌ Erreur lors du test de navigation: {result.stderr}")
                return None
